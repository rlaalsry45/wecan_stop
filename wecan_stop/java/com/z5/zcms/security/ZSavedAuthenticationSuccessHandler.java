...
public class ZSavedAuthenticationSuccessHandler extends SavedRequestAwareAuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(
        ...
        try {
            ...
            String useyn = userLogService.selectUseyn(userVo);
            if("N".equals(useyn)) {
            	response.sendRedirect(request.getContextPath() + "/login.html?usefail=true");
            }
            ...
            if (list.size() > 0) {
                ...
                comSetVO.setProjectCode(codeVO.getCode());
            }
