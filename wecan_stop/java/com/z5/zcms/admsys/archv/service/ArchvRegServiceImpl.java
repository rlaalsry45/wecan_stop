...
@Service
@Transactional
public class ArchvRegServiceImpl extends AbstractServiceImpl implements ArchvRegService {
...
//					break;
	...
	public void delArchvFiles(int archv_no) throws Exception {
		this.archvDAO.delArchvFiles(archv_no);
	}
	...
	public void updateHits(int archv_no) throws Exception {
		this.archvDAO.updateHits(archv_no);
	}
