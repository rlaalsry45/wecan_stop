...
//          int pageSize = data.getInt("pageSize", Integer.parseInt(EgovProperties.getProperty("Globals.list.count")));
    ...
    public String insertPost(@ModelAttribute("zUserVo") ZUserVo zUserVo, HttpServletRequest req, Model model, HttpSession session) {
        enter();
        param(req);
