    ...
    public int doStartTag() throws JspException {
        ...
        if (authMenu != null && authMenu.size() > 0) {
            if ("gnb".equals(opt)) { /* Global Navigation Bar */
                ...
                buffer.append("	<a href='").append(authMenu.get(0).getUrllink()).append("' class='logo'><span>").append(projectName).append("</span></a>\n");
                ...
                for (MenuAuthVo gnb : authMenu) {
                    if (gnb.getUrllevel() == 0) {
                    	...
                    	else if(index == 6) {imgSrc="/cms/image/main/ico-admin-home-copy-4.png";}
