...
//        documentRoot = EgovProperties.getProperty("Globals.fileManager");


        this.referer = request.getHeader("referer");

        //		this.fileManagerRoot = documentRoot + referer.substring(referer.indexOf(contextPath), referer.indexOf("index.jsp"));
        this.fileManagerRoot = EgovProperties.getPathProperty("Globals.fileManager");
...
//        print("doc_root=" + this.documentRoot);
        dateFormat = new SimpleDateFormat(config.getProperty("date"));


        //System.out.println("config -====>"+config.getProperty("doc_root"));
    ...
    public JSONObject getFolder() {
        ...
        //		System.out.println("path===>"+this.get.get("path"));
        //		System.out.println("url====>"+documentRoot + this.get.get("path"));
    ...
    private void loadConfig() {
        ...
        if (config == null) {
            try {
                is = new FileInputStream(this.fileManagerRoot + "connectors/jsp/config.properties");
    ...
    private void loadLanguageFile() {
        ...
        if (language == null) {
            ...
            try {
                ...
                while ((text = br.readLine()) != null) contents.append(text);
