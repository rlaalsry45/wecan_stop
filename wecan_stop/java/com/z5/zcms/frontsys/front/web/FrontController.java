...
//        SecuritySessionUtil.toString(request);
        ...
        //frontsys에 portal 이 들어오면 login.html 로 보낸다.
        if ( StringUtils.contains(hostname(request), "portal.women1366.kr") ) {
...
//            SecuritySessionUtil.toString(request);
    ...
    @RequestMapping(value = "_main/main.html")
