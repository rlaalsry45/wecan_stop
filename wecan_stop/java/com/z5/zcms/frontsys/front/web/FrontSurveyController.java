...
//							cnt[0] = packSubject;
    ...
    @RequestMapping(value = "{surveyid}")
    public String surveyidList(HttpServletRequest request, Model model) throws Exception {

        try {
        	ZSurveyVo zSurveyVo = new ZSurveyVo();
        	zSurveyVo = (ZSurveyVo) surveyService.getSurveyIdList(zSurveyVo);
