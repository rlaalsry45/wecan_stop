...
public class SurveyServiceImpl extends AbstractServiceImpl implements SurveyService {
    ...
    public int surveyWrite(ZSurveyVo zSurveyVo) {
        return this.zSurveyDAO.surveyWrite(zSurveyVo);
    }
	...
	public ZSurveyVo getSurveyOfOrgid(ZSurveyVo zSurveyVo) {
		return this.zSurveyDAO.getSurveyOfOrgid(zSurveyVo);
	}

	@Override
	public Model cSurveyResultWrite(Model model, ZSurveyResultVo zSurveyResultVo) {
		
		try {
			zSurveyResultDAO.surveyResultWrite(zSurveyResultVo);
			zSurveyResultDAO.surveyResultTotalUpdate(zSurveyResultVo);
        } catch (Exception e) {
            e.printStackTrace();
        }
	...
	public List<ZSurveyResultVo> surveyResultList(ZSurveyResultVo zSurveyResultVo) {
		return this.zSurveyResultDAO.surveyResultList(zSurveyResultVo);
	}

	@Override
	public int resultListCount(ZSurveyResultVo zSurveyResultVo) {
		return this.zSurveyResultDAO.resultListCount(zSurveyResultVo);
	}

	@Override
	public ZSurveyResultVo surveyResult(ZSurveyResultVo zSurveyResultVo) {
		return this.zSurveyResultDAO.surveyResult(zSurveyResultVo);
	}
}
