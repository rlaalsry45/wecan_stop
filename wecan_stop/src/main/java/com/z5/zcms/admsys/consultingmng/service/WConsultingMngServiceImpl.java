...
public class WConsultingMngServiceImpl extends EgovAbstractServiceImpl implements WConsultingMngService {
	...
	@Override
	public Model index_clthisOld(WClthisOldVo reqVo, DataTable input, Model model) throws Exception {
		int pageSize = input.getInt("pageSize", Integer.parseInt(EgovProperties.getProperty("Globals.list.count")));
        if (input.getInt("pageIndex") == 0) {
            input.put("pageIndex", 1);
        }
        ...
        List<WClthisOldVo> list = this.wConsultingMngDAO.getlist(reqVo);
	...
	public WClthisOldVo view_clthisOld(WClthisOldVo reqVo) throws Exception {
		return wConsultingMngDAO.view(reqVo);
	}

	@Override
	public List<WClthisOldVo> answerList_clthisOld(WClthisOldVo reqVo) throws Exception {
		return wConsultingMngDAO.getAnswerList_clthisOld(reqVo);
	}
	...
	@Override
	public Model index_old(WConsultingOldMngVo reqVo, DataTable input, Model model) throws Exception {
		int pageSize = input.getInt("pageSize", Integer.parseInt(EgovProperties.getProperty("Globals.list.count")));
        if (input.getInt("pageIndex") == 0) {
            input.put("pageIndex", 1);
        }
        ...
        List<WConsultingOldMngVo> list = this.wConsultingMngDAO.getlist(reqVo);
