...
public class ZFormMailVo extends CommonVo{
	...
	public int getFormmailno() {
		return formmailno;
	}
	public void setFormmailno(int formmailno) {
		this.formmailno = formmailno;
	}
