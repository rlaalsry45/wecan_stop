...
public class GAuthEmp extends CommonVo {
	...
	private String latestconnectiondate;
	...
	public String getLatestconnectiondate() {
		return latestconnectiondate;
	}

	public void setLatestconnectiondate(String latestconnectiondate) {
		this.latestconnectiondate = latestconnectiondate;
	}
	...
	public void setUSERDATEREGFrom(String uSERDATEREGFrom) {
		USERDATEREGFrom = uSERDATEREGFrom;
	}
