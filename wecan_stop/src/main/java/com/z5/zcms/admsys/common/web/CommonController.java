...
*/
    ...
    @RequestMapping(value = "/admsys/header.html") 
        ...
        try {
            ...
            if (ok) {
                ...
                try {
                    ...
                    //String   addr = part[0] + "." + part[1] + "." + part[2] + "." + part[3];
            ...
            String adminMenuYn = menuAuthService.adminPermissionMenuYn(userid);
            session.setAttribute("adminMenuYn", adminMenuYn);
