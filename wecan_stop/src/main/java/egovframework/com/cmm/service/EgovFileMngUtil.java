...
public class EgovFileMngUtil {
     ...
     * @param saveFilePath
     */
    public static void writeUploadedFile(MultipartFile file, String newName, String saveFilePath) {
        InputStream  stream = null;
        OutputStream bos    = null;

        try {
            stream = file.getInputStream();
            File cFile = new File(EgovWebUtil.filePathBlackList(saveFilePath));
            ...
            bos = new FileOutputStream(EgovWebUtil.filePathBlackList(saveFilePath + File.separator + newName));
    ...
    public static void downFile(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if (request.getAttribute("orgFileName") == null) {
            orgFileName = "";
        } else {
        ...
        BufferedOutputStream fou = null;

        try {
            fin = new BufferedInputStream(new FileInputStream(file));
            fou = new BufferedOutputStream(response.getOutputStream());
            int read = 0;
    ...
    public static HashMap<String, String> uploadFile(MultipartFile file, String urlPath) {

        HashMap<String, String> map = new HashMap<String, String>();
        //Write File 이후 Move File????
        String newName;
        String stordFilePath = EgovProperties.getPathProperty(urlPath);
        String orginFileName = file.getOriginalFilename();
    ...
    public static HashMap<String, String> uploadFileIMG(MultipartFile file, String urlPath) {
        ...
        //newName 은 Naming Convention에 의해서 생성
        newName = getTimeStamp();    // 2012.11 KISA 보안조치
        writeFile(file, newName + "." + fileExt, stordFilePath);
        //storedFilePath는 지정
        map.put(Globals.ORIGIN_FILE_NM, orginFileName);
        map.put(Globals.UPLOAD_FILE_NM, newName);
        map.put(Globals.FILE_EXT, fileExt);
    ...
    public static HashMap<String, String> uploadFileIMG(MultipartFile file, String urlPath, String addUrl) {

        HashMap<String, String> map = new HashMap<String, String>();
        //Write File 이후 Move File????
        String newName       = "";
        String stordFilePath = EgovProperties.getProperty(urlPath) + addUrl;
        String orginFileName = file.getOriginalFilename();
...
//			String mimetype = "application/unknown"; //"application/x-msdownload"
