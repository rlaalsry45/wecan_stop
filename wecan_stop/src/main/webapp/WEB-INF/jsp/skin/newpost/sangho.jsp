 ...
 */
   ...
   function changeAreaList(idx, obj){	
	...
	function normalSearch(currentPage){
		...
		var keyword = "";
		//var cityText='',countyText='',townText='',orgNm='어린이급식관리지원센터',orgCode='232';
		var cityText='',countyText='',townText='',orgNm='${orgNm}',orgCode='${orgCode}';
		...
		url = "/skin/newpost/AjaxRequestXML.jsp?getUrl="+escape("http://www.juso.go.kr/link/search.do?extend=true&mode=road_search&searchType=location_buld&topTab=1&engineCtpNm="+encodeURI(cityText)+"&engineSigNm="+encodeURI(countyText)+"&engineEmdNm="+encodeURI(townText)+"&engineBdNm="+encodeURI(trim(form.bdnm.value))+"&currentPage="+currentPage+"&orgCode="+orgCode+"&orgNm="+encodeURI(orgNm));
	...
	function normalSearch2(currentPage){
		var url;
		var form = document.check;
		//var orgNm='어린이급식관리지원센터',orgCode='232';
		var orgNm='${orgNm}',orgCode='${orgCode}';
		form.currentPage.value =currentPage;

		currentPage=parseInt((currentPage/10)+1);
				   
		url = "/skin/newpost/AjaxRequestXML.jsp?getUrl="+escape("http://www.juso.go.kr/link/search.do?extend=true&mode=road_search&searchType=location_buld&topTab=1&engineCtpNm="+encodeURI(form.engineCtpNm.value)+"&engineSigNm="+encodeURI(form.engineSigNm.value)+"&engineEmdNm="+encodeURI(form.engineEmdNm.value)+"&engineBdNm="+encodeURI(trim(form.engineBdNm.value))+"&currentPage="+currentPage+"&orgCode="+orgCode+"&orgNm="+encodeURI(orgNm));
