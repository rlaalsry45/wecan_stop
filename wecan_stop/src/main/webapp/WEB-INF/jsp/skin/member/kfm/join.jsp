...
<form name="frm" method="post">
	...
	<div class="email">
		KF지원사업신청포털 사이트에 이메일 아이디가 있는 회원
	...
	<table class="board-write" summary="E-mail, Password, Re-enter Password, Name (in native language), Name (English), Name (English), E-mail subscription ">
		...
		<tbody>
			<tr>
				...
				<td><input type="text" name="userid" id="userid"  class="text" title="E-mail" style="width:196px;height:18px;" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="type">
					...
					<input type="checkbox" name="newsletter2" id="newsletter" class="check"  value="1" />
					<label for="newsletter">KF Newsletter</label>
					<input type="checkbox" name="newsletter3"id="focus" class="check"  value="1" />
					<label for="focus">Korea Focus</label>
					<input type="checkbox" name="newsletter4" id="kf" class="check"  value="1" />
					<label for="kf">KF Newsletter</label>
				</td>
			</tr>
		</tbody>
	</table>
