                ...
                <section class="login-form">
                    <div class="login-form-in">
                        <form action="/j_spring_security_check" method="post" id="frm" onsubmit="return valchk();">
                            ...
                            <fieldset>
                                <legend>로그인 폼</legend>
                                <input type="text" name="j_username" id="userid" title="아이디 입력" onkeydown="if(event.keyCode==13){valchk()}"
                                       placeholder="아이디를 입력해주세요">
                                <input type="password" name="j_password" id="userpasswd" title="비밀번호 입력" onkeydown="if(event.keyCode==13){valchk()}"
                        ...
                        <ul class="member-btns">
                            <li><a href="/?menuno=30&act=join_type">회원가입</a></li>
                            <li><a href="/?menuno=30&act=find_id">아이디찾기</a></li>
                            <li><a href="/?menuno=30&act=find_pw">비밀번호찾기</a></li>
                        </ul>
                    </div>
                </section>
            </div>
