...
<form:form modelAttribute="frontBoardVo" name="board" method="post" action="${post_url}" >
		...
		<dl class="bbs_pre_next">
			...
			<dd><a href="#none" onclick="return submitForm(this,'prev', ${view.prevno})"><c:out value="${view.prevtitle}" escapeXml="false" /></a></dd>
			<dt><spring:message code="text.next"/></dt>
			<dd><a href="#none" onclick="return submitForm(this,'next', ${view.nextno})"><c:out value="${view.nexttitle}" escapeXml="false" /></a></dd>
		</dl>
		...
		<div class="tac">
			...
			<a href="#none" onclick="return submitForm(this,'list', ${view.bbsno})" class="webtong-btn filled round basic big mt20"><spring:message code="button.list"/>dd</a>
		</div>
