...
<table class="view_style_1" summary="채용정보 보기페이지">
	<caption>>" ${view.bbstitle} " 글의 제목, 파일, 게시일, 접수시작일자, 저부마감일자, 접수사이트, 조회수, 내용 정보를 제공합니다.</caption>
	<colgroup>
		<col width="15%">
		<col width="*">
	</colgroup>
	...
	<c:if test="${not empty filelist}">
		...
		<tr>
			...
			<td class="td_left">${view.sdate}</td>
		</tr>
		<tr>
			<th scope="row">접수마감</th>
			<td class="td_left">${view.edate}</td>
		</tr>
		<tr>
			<th scope="row">접수사이트</th>
			<td class="td_left"><a href="https://www.kpfis.or.kr/download.do?uuid=1c259633-ff5c-4af4-9f5a-2e8d974cfb47" target="_blank" title="접수사이트로 새창열림">사이트 바로가기</a></td>
		</tr>
		<tr>
			<th scope="row">조회수</th>
