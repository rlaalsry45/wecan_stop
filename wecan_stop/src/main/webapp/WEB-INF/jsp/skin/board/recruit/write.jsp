...
<table class="write_style_1">
	...
	<tbody>
      ...
      <c:if test="${cateyn=='1'&&(not empty map)}">
		...
		<tr>
			<th scope="row">접수시작</th>		
			<td class="ng-scope">
				<input id="sdate1"  name="sdate" class="Wdate" type="text" value="${detail.sdate}" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" readonly />
			</td>
		</tr>
		<tr>
			<th scope="row">접수마감</th>		
			<td class="ng-scope">
				<input id="edate1" name="edate" class="Wdate" type="text" value="${detail.edate}" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" readonly />
			</td>
		</tr>
		<tr>
			<th scope="row">접수사이트</th>
			<td><input type="text" name="bbsuserhomepage" class="input_1" value="<c:out value='${detail.bbsuserhomepage}' escapeXml="false"/>"></td>
		</tr>		
		<tr>
			<th scope="row">내용</th>
			<td>
