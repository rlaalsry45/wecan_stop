...
<caption>상세 페이지입니다. 부패행위유형,금액,징계종류,처분일,고발여부로 구성된 테이블입니다.</caption>
<colgroup>
	<col width="12%">
	<col width="auto">
</colgroup>
<tbody>
<tr>
	<th scope="row"><label for="bbstitle">부패행위유형</label></th>
...
<tr>
	<th scope="row"><label for="public_yn">금액</label></th>
	<td><fmt:formatNumber type="number" groupingUsed="true" value="${view.etc3}"/></td>
</tr>
<tr>
	<th scope="row"><label for="title">징계종류</label></th>
	<td>${view.etc7}</td>
</tr>
<tr>
	<th scope="row"><label for="title">처분일</label></th>
	<td>${view.etc8}</td>
</tr>
<tr>
	<th scope="row"><label for="title">고발여부</label></th>
	<td>${'1'==view.etc9 ? '예' :'아니오'}</td>
</tr>
<tr>
	<th scope="row">내용</th>
