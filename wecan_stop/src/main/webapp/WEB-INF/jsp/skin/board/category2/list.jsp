...
<table class="list_style_1">
	...
	<caption>카테고리, 제목을 제공하며 제목 링크를 통해 상세페이지로 이동합니다.</caption>
	<colgroup>
		<col width="15%">
		<col width="30%">
	</colgroup>
	...
	<tbody>
        <c:forEach items="${list}" var="data" varStatus="status">
 		<tr>
			...
			<td class="td_left">
				<c:if test="${data.bbsnotice=='1'}"><font class="list_none" style="color:red;font-weight:bold;">공지</font>&nbsp;</c:if>
        ...
        <c:if test="${input.total+nCount==0}">
            <tr>
                <td class="first" colspan="2">등록 된 게시물이 없습니다.</td>
            </tr>
        </c:if>
	</tbody>
</table>
