            ...
            <div class="right_cont">
                ...
                <div class="survey">
                    <form:form modelAttribute="ZSurveyResultVo" name="frm" method="post">
                    	<input type="hidden" id="surveyType" name="surveyType" value="A">
                        <dl>
                        ...
                        <dl>
                            ...
                            <dd>
                                <ul class="w_auto">
                                    ...
                                    <li><input type="checkbox" id="num10_7" class="num07" name="askno10_7" value="Y"><label for="num10_7"> 기타</label>
                                        <div class="text_area">
                        ...
                        <dl>
                            ...
                            <dd>
                                <ul class="w_4">
                                    <li><input type="radio" id="num15_1" class="num01" name="askno16" value="1"><label for="num15_1"> 일반직 공무원</label></li>
                                    <li><input type="radio" id="num15_2" class="num02" name="askno16" value="2"><label for="num15_2"> 특정직 공무원</label></li>
                                    <li><input type="radio" id="num15_3" class="num03" name="askno16" value="3"><label for="num15_3"> 별정직･정무직 공무원</label></li>
                                    <li><input type="radio" id="num15_4" class="num04" name="askno16" value="4"><label for="num15_4"> 공무직</label></li>
                                    <li><input type="radio" id="num15_5" class="num05" name="askno16" value="5"><label for="num15_5"> 그외 기간제 등</label></li>
                                </ul>
