    ...
    <div id="r_side">
        <div id="contents">
            <div class="contants_top">
                <div class="location">
                    <a href="/admsys/dashboard/index.html">HOME</a> <a href="/admsys/orgculturedigmng/index.html">성희롱방지 조직문화진단관리</a> <a href="index.html">설문조사 관리</a> <strong>설문조사 결과</strong>
                </div>
            </div>
            <div id="content">
                <ul class="homepagebbs">
                    <li class="bg"><h3 class="sub">설문조사 결과</h3></li>
                    <li>
                        <div class="main_table">
                            <table class="main_table1 bgneno" summary="제목, ID, 기관명, 상태, 기간설정, 설명, 응답자수">
                                <caption>설문조사 결과</caption>
                                <colgroup>
                                    <col width="150px"/>
                                    <col/>
                                </colgroup>
                                ...
                                <tr>
                    				...
                    				<td class="Tleft">${result.surveyid}</td>
               					</tr>
                				<tr>
                    				<th class="Tbornone Tleft">기관명</th>
                    				<td class="Tleft">${result.orgname}</td>
                    			</tr>
                                <tr>
