            ...
            <div id="contents">
                <form:form modelAttribute="ZSatisfactionVo" name="frm" method="post">
                    <div class="contents_top">
                        <div class="location">
                            <a href="/admsys/dashboard/index.html">HOME</a> <a href="/admsys/orgculturedigmng/index.html">성희롱방지 조직문화진단관리</a> <strong>만족도조사 관리</strong>
                        </div>
                        <div class="TopSearch">
...
<!-- 							</p> -->
                        ...
                        function excelDownload(){
							var eForm = $("#ZSatisfactionVo").serialize();
							
							$.ajax({
								  type: 'POST',
								  url: "/admsys/module/satisfaction/index_excel.html",
								  data: eForm,
								  traditional:true,
                        ...
                        function view(satisfactionno){
                        	$("#content").load("/admsys/module/satisfaction/view.html", {'no': satisfactionno} ); 
                        }
