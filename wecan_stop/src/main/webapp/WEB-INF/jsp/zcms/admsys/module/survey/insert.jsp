...
<jsp:include page="../../lnb.jsp" flush="true" />
            ...
            <script type="text/javascript">
                ...
                function openGovIdSrchPop(){
            		PopupCenter('/admsys/orgculturedigmng/govIdSearchPop.html?mode=POP', 'popupSearchGovIdList','500','700');
            	}
                
                function openConsultingSrchPop(){
            		PopupCenter('/admsys/orgculturedigmng/consultingSearchPop.html?mode=POP&orgid='+$("#orgid").val(), 'popupSearchConsultingList','500','700');
            	}
                
                function setGovIdInfo(code, name){
            		$("#orgid").val(code);
            	}
                
                function setConsultingInfo(code){
            		$("#consultingapplicationno").val(code);
            	}
            ...
            <div id="contents">
               <div class="contants_top">
                    <div class="location">
                        <a href="/admsys/dashboard/index.html">HOME</a> <a href="/admsys/orgculturedigmng/index.html">성희롱방지 조직문화진단관리</a> <a href="index.html">설문조사 관리</a> <strong>설문조사 등록</strong> 
                    </div>
                </div>
                <form:form modelAttribute="zSurveyVo" name="frm" method="post">
                    ...
                    <input type="hidden" name="title" value="설문조사_${zuser.chargeorgid}" />
                    <input type="hidden" name="contstype" value="1" />
                    <input type="hidden" name="target" value="0" />
                    <input type="hidden" name="mainview" value="0" />
                    <input type="hidden" name="conts" value="" />
                    
                    <div id="content">
                        <ul class="homepagebbs">
                            <li class="bg"><h3 class="sub">설문조사 등록</h3></li>
                            <li>
                                <div class="main_table">
                                    <!-- 게시판 영역 -->
                                    <table class="main_table1 bgneno" summary="제목, 기관명, 기간 설정, 대상 선택, 메인에 보기 표시, 설명, 문항 관리">
                                        <caption>설문조사 등록</caption>
                                        <colgroup>
                                            <col width="150" />
                                            <col width="" />
                                        </colgroup>
                                        <tr>
                                            <th class="Tbornone Tleft">기관ID</th>
                                            <td class="Tleft"><input type="text" name="orgid" id="orgid" class="bor1ddd" size="30" maxlength="8" />
                                        	<input type="button" id="srchBtnGovId" onclick="openGovIdSrchPop();" style="cursor: pointer;" value="기관ID 검색" style="display:none;"></td>
                                        </tr>
                                        <tr>
                                            <th class="Tbornone Tleft">진단일지</th>
                                            <td class="Tleft"><input type="text" name="consultingapplicationno" id="consultingapplicationno" class="bor1ddd" size="30" />
                                            <input type="button" id="srchBtnConsulting" onclick="openConsultingSrchPop();" style="cursor: pointer;" value="진단일지 검색" style="display:none;"></td>
                                        </tr>
                                        <tr>
                                            <th class="Tbornone Tleft">유형</th>
                                            <td class="Tleft">
                                            	<input type="radio" class="radio1" name="surveytype" value="A" />
                                                A
                                                <input type="radio" class="radio1" name="surveytype" value="B" />
                                                B
                                            </td>
                                        </tr>
                                        <tr>
