							...
							<tbody>
								<tr>
									...
									<c:forEach items="${dailyList}" var="each" varStatus="loop">
										...
										<c:forEach items="${consultingList}" var="each2" varStatus="loop">	
								...
								<tr>
									...
									<c:if test="${consultingType eq 'public'}">
										<c:forEach items="${dailyList}" var="each" varStatus="loop">
											<c:set var="counselCnt1" value="0"/>
											<c:forEach items="${consultingTypeList}" var="each2" varStatus="loop">	
												<c:if test="${each.days eq each2.regDate}">
												<c:set var="counselCnt1" value="${each2.counselCnt1}"/>
												</c:if>
											</c:forEach>
								...
								<tr>
									<c:if test="${loop.index eq 0}">
									<th rowspan="${fn:length(receivedTypeCbx)}">경로</th>
									</c:if>
									<th>
									...
									<c:if test="${receivedType eq 'tel'}">
										<c:forEach items="${dailyList}" var="each" varStatus="loop">
											<c:set var="counselCnt1" value="0"/>
											<c:forEach items="${receivedTypeList}" var="each2" varStatus="loop">	
												<c:if test="${each.days eq each2.regDate}">
												<c:set var="counselCnt1" value="${each2.counselCnt1}"/>
												</c:if>
											</c:forEach>
								...
								<c:forEach items="${consultingReqTypeCbx}" var="consultingReqType" varStatus="loop">	
								<tr>
									<c:if test="${loop.index eq 0}">
									<th rowspan="${fn:length(consultingReqTypeCbx)}">내용</th>
									</c:if>
									<th>
									<c:if test="${consultingReqType eq 'relaccident'}">사건관련</c:if>
									<c:if test="${consultingReqType eq 'simple'}">단순문의</c:if>
									<c:if test="${consultingReqType eq 'etc'}">기타</c:if>
									</th>
									<c:set var="sum1" value="0"/>
									<c:set var="sum2" value="0"/>
									<c:set var="sum3" value="0"/>
									<c:if test="${consultingReqType eq 'relaccident'}">
										<c:forEach items="${dailyList}" var="each" varStatus="loop">
											<c:set var="counselCnt1" value="0"/>
											<c:forEach items="${consultingReqTypeList}" var="each2" varStatus="loop">	
												<c:if test="${each.days eq each2.regDate}">
												<c:set var="counselCnt1" value="${each2.counselCnt1}"/>
												</c:if>
											</c:forEach>
									...
									<c:if test="${consultingReqType eq 'simple'}">
										<c:forEach items="${dailyList}" var="each" varStatus="loop">
											<c:set var="counselCnt2" value="0"/>
											<c:forEach items="${consultingReqTypeList}" var="each2" varStatus="loop">	
												<c:if test="${each.days eq each2.regDate}">
									...
									<c:if test="${consultingReqType eq 'etc'}">
										<c:forEach items="${dailyList}" var="each" varStatus="loop">
											<c:set var="counselCnt3" value="0"/>
											<c:forEach items="${consultingReqTypeList}" var="each2" varStatus="loop">	
												<c:if test="${each.days eq each2.regDate}">
								...
								<c:forEach items="${contactMethodTypeCbx}" var="contactMethodType" varStatus="loop">	
								<tr>
									<c:if test="${loop.index eq 0}">
									<th rowspan="${fn:length(contactMethodTypeCbx)}">유입경로</th>
									</c:if>
									<th>
									<c:if test="${contactMethodType eq 'internet'}">인터넷 검색</c:if>
									<c:if test="${contactMethodType eq 'support'}">피해자 지원기관 등</c:if>
									<c:if test="${contactMethodType eq 'gov'}">여성가족부</c:if>
									<c:if test="${contactMethodType eq 'etc'}">기타</c:if>
									<c:if test="${contactMethodType eq 'unknown'}">미파악</c:if>
									</th>
									<c:set var="sum1" value="0"/>
									<c:set var="sum2" value="0"/>
									<c:set var="sum3" value="0"/>
									...
									<c:if test="${contactMethodType eq 'internet'}">
										<c:forEach items="${dailyList}" var="each" varStatus="loop">
											<c:set var="counselCnt1" value="0"/>
											<c:forEach items="${contactMethodTypeList}" var="each2" varStatus="loop">	
												<c:if test="${each.days eq each2.regDate}">
												<c:set var="counselCnt1" value="${each2.counselCnt1}"/>
												</c:if>
											</c:forEach>
									...
									<c:if test="${contactMethodType eq 'support'}">
										<c:forEach items="${dailyList}" var="each" varStatus="loop">
											<c:set var="counselCnt2" value="0"/>
											<c:forEach items="${contactMethodTypeList}" var="each2" varStatus="loop">	
												<c:if test="${each.days eq each2.regDate}">
									...
									<c:if test="${contactMethodType eq 'gov'}">
										<c:forEach items="${dailyList}" var="each" varStatus="loop">
											<c:set var="counselCnt3" value="0"/>
											<c:forEach items="${contactMethodTypeList}" var="each2" varStatus="loop">	
												<c:if test="${each.days eq each2.regDate}">
									...
									<c:if test="${contactMethodType eq 'etc'}">
										<c:forEach items="${dailyList}" var="each" varStatus="loop">
											<c:set var="counselCnt4" value="0"/>
											<c:forEach items="${contactMethodTypeList}" var="each2" varStatus="loop">	
												<c:if test="${each.days eq each2.regDate}">
									...
									<c:if test="${contactMethodType eq 'unknown'}">
										<c:forEach items="${dailyList}" var="each" varStatus="loop">
								...
								<tr>
									...
									<c:if test="${clientVictimRelType eq 'doer'}">행위자등</c:if>
									...
									<c:if test="${clientVictimRelType eq 'doer'}">
										<c:forEach items="${dailyList}" var="each" varStatus="loop">
											<c:set var="counselCnt4" value="0"/>
											<c:forEach items="${clientVictimRelTypeList}" var="each2" varStatus="loop">	
												<c:if test="${each.days eq each2.regDate}">
								...
								<c:forEach items="${victimGenderTypeCbx}" var="victimGenderType" varStatus="loop">	
								<tr>
									<c:if test="${loop.index eq 0}">
									<th rowspan="${fn:length(victimGenderTypeCbx)}">피해자 성별</th>
									</c:if>
									<th>
									<c:if test="${victimGenderType eq 'female'}">여성</c:if>
									<c:if test="${victimGenderType eq 'male'}">남성</c:if>
									<c:if test="${victimGenderType eq 'unknown'}">미상</c:if>
									<c:if test="${victimGenderType eq 'none'}">해당사항없음</c:if>
									</th>
									<c:set var="sum1" value="0"/>
									<c:set var="sum2" value="0"/>
									<c:set var="sum3" value="0"/>
									<c:set var="sum4" value="0"/>
									<c:if test="${victimGenderType eq 'female'}">
										<c:forEach items="${dailyList}" var="each" varStatus="loop">
											<c:set var="counselCnt1" value="0"/>
											<c:forEach items="${victimGenderTypeList}" var="each2" varStatus="loop">	
												<c:if test="${each.days eq each2.regDate}">
												<c:set var="counselCnt1" value="${each2.counselCnt1}"/>
												</c:if>
											</c:forEach>
									...
									<c:if test="${victimGenderType eq 'male'}">
										<c:forEach items="${dailyList}" var="each" varStatus="loop">
											<c:set var="counselCnt2" value="0"/>
											<c:forEach items="${victimGenderTypeList}" var="each2" varStatus="loop">	
												<c:if test="${each.days eq each2.regDate}">
									...
									<c:if test="${victimGenderType eq 'unknown'}">
										<c:forEach items="${dailyList}" var="each" varStatus="loop">
											<c:set var="counselCnt3" value="0"/>
											<c:forEach items="${victimGenderTypeList}" var="each2" varStatus="loop">	
												<c:if test="${each.days eq each2.regDate}">
									...
									<c:if test="${victimGenderType eq 'none'}">
										<c:forEach items="${dailyList}" var="each" varStatus="loop">
											<c:set var="counselCnt4" value="0"/>
											<c:forEach items="${victimGenderTypeList}" var="each2" varStatus="loop">	
												<c:if test="${each.days eq each2.regDate}">
								...
								<c:forEach items="${offenderGenderTypeCbx}" var="offenderGenderType" varStatus="loop">	
								<tr>
									<c:if test="${loop.index eq 0}">
									<th rowspan="${fn:length(offenderGenderTypeCbx)}">행위자 성별</th>
									</c:if>
									<th>
									<c:if test="${offenderGenderType eq 'female'}">여성</c:if>
									<c:if test="${offenderGenderType eq 'male'}">남성</c:if>
									<c:if test="${offenderGenderType eq 'unknown'}">미상</c:if>
									<c:if test="${offenderGenderType eq 'none'}">해당사항없음</c:if>
									</th>
									<c:set var="sum1" value="0"/>
									<c:set var="sum2" value="0"/>
									<c:set var="sum3" value="0"/>
									<c:set var="sum4" value="0"/>
									<c:if test="${offenderGenderType eq 'female'}">
										<c:forEach items="${dailyList}" var="each" varStatus="loop">
											<c:set var="counselCnt1" value="0"/>
											<c:forEach items="${offenderGenderTypeList}" var="each2" varStatus="loop">	
												<c:if test="${each.days eq each2.regDate}">
												<c:set var="counselCnt1" value="${each2.counselCnt1}"/>
												</c:if>
											</c:forEach>
									...
									<c:if test="${offenderGenderType eq 'male'}">
										<c:forEach items="${dailyList}" var="each" varStatus="loop">
											<c:set var="counselCnt2" value="0"/>
											<c:forEach items="${offenderGenderTypeList}" var="each2" varStatus="loop">	
												<c:if test="${each.days eq each2.regDate}">
									...
									<c:if test="${offenderGenderType eq 'unknown'}">
										<c:forEach items="${dailyList}" var="each" varStatus="loop">
											<c:set var="counselCnt3" value="0"/>
											<c:forEach items="${offenderGenderTypeList}" var="each2" varStatus="loop">	
												<c:if test="${each.days eq each2.regDate}">
									...
									<c:if test="${offenderGenderType eq 'none'}">
										<c:forEach items="${dailyList}" var="each" varStatus="loop">
											<c:set var="counselCnt4" value="0"/>
											<c:forEach items="${offenderGenderTypeList}" var="each2" varStatus="loop">	
												<c:if test="${each.days eq each2.regDate}">
								...
								<c:forEach items="${offenderVictimRelTypeCbx}" var="offenderVictimRelType" varStatus="loop">	
								<tr>
									<c:if test="${loop.index eq 0}">
									<th rowspan="${fn:length(offenderVictimRelTypeCbx)}">행위자 피해자와의 관계</th>
									</c:if>
									<th>
									<c:if test="${offenderVictimRelType eq 'boss'}">기관장/사업주</c:if>
									<c:if test="${offenderVictimRelType eq 'senior'}">상급자</c:if>
									<c:if test="${offenderVictimRelType eq 'partner'}">동료</c:if>
									<c:if test="${offenderVictimRelType eq 'otherrel'}">그 외 업무관계자</c:if>
									<c:if test="${offenderVictimRelType eq 'etc'}">기타</c:if>
									<c:if test="${offenderVictimRelType eq 'unknown'}">미파악</c:if>
									</th>
									<c:set var="sum1" value="0"/>
									<c:set var="sum2" value="0"/>
									<c:set var="sum3" value="0"/>
									...
									<c:if test="${offenderVictimRelType eq 'boss'}">
										<c:forEach items="${dailyList}" var="each" varStatus="loop">
											<c:set var="counselCnt1" value="0"/>
											<c:forEach items="${offenderVictimRelTypeList}" var="each2" varStatus="loop">	
												<c:if test="${each.days eq each2.regDate}">
												<c:set var="counselCnt1" value="${each2.counselCnt1}"/>
												</c:if>
											</c:forEach>
									...
									<c:if test="${offenderVictimRelType eq 'senior'}">
										<c:forEach items="${dailyList}" var="each" varStatus="loop">
											<c:set var="counselCnt2" value="0"/>
											<c:forEach items="${offenderVictimRelTypeList}" var="each2" varStatus="loop">	
												<c:if test="${each.days eq each2.regDate}">
									...
									<c:if test="${offenderVictimRelType eq 'partner'}">
										<c:forEach items="${dailyList}" var="each" varStatus="loop">
											<c:set var="counselCnt3" value="0"/>
											<c:forEach items="${offenderVictimRelTypeList}" var="each2" varStatus="loop">	
												<c:if test="${each.days eq each2.regDate}">
									...
									<c:if test="${offenderVictimRelType eq 'otherrel'}">
										<c:forEach items="${dailyList}" var="each" varStatus="loop">
											<c:set var="counselCnt4" value="0"/>
											<c:forEach items="${offenderVictimRelTypeList}" var="each2" varStatus="loop">	
												<c:if test="${each.days eq each2.regDate}">
									...
									<c:if test="${offenderVictimRelType eq 'etc'}">
										<c:forEach items="${dailyList}" var="each" varStatus="loop">
											<c:set var="counselCnt5" value="0"/>
											<c:forEach items="${offenderVictimRelTypeList}" var="each2" varStatus="loop">	
												<c:if test="${each.days eq each2.regDate}">
									...
									<c:if test="${offenderVictimRelType eq 'unknown'}">
										<c:forEach items="${dailyList}" var="each" varStatus="loop">
								...
								<c:forEach items="${harmFirstTypeCbx}" var="harmFirstType" varStatus="loop">	
								<tr>
									<c:if test="${loop.index eq 0}">
									<th rowspan="${fn:length(harmFirstTypeCbx)}">피해</th>
									</c:if>
									<th>
									<c:if test="${harmFirstType eq 'rape'}">강간/유사강간</c:if>
									<c:if test="${harmFirstType eq 'harass'}">그외 추행</c:if>
									<c:if test="${harmFirstType eq 'verbal'}">언어적</c:if>
									<c:if test="${harmFirstType eq 'visual'}">시각적</c:if>
									<c:if test="${harmFirstType eq 'etc'}">기타 성희롱</c:if>
									</th>
									<c:set var="sum1" value="0"/>
									<c:set var="sum2" value="0"/>
									<c:set var="sum3" value="0"/>
									<c:set var="sum4" value="0"/>
									<c:set var="sum5" value="0"/>
									<c:if test="${harmFirstType eq 'rape'}">
										<c:forEach items="${dailyList}" var="each" varStatus="loop">
											<c:set var="counselCnt1" value="0"/>
											<c:forEach items="${harmFirstTypeList}" var="each2" varStatus="loop">	
												<c:if test="${each.days eq each2.regDate}">
												<c:set var="counselCnt1" value="${each2.counselCnt1}"/>
												</c:if>
											</c:forEach>
									...
									<c:if test="${harmFirstType eq 'harass'}">
										<c:forEach items="${dailyList}" var="each" varStatus="loop">
											<c:set var="counselCnt2" value="0"/>
											<c:forEach items="${harmFirstTypeList}" var="each2" varStatus="loop">	
												<c:if test="${each.days eq each2.regDate}">
									...
									<c:if test="${harmFirstType eq 'verbal'}">
										<c:forEach items="${dailyList}" var="each" varStatus="loop">
											<c:set var="counselCnt3" value="0"/>
											<c:forEach items="${harmFirstTypeList}" var="each2" varStatus="loop">	
												<c:if test="${each.days eq each2.regDate}">
									...
									<c:if test="${harmFirstType eq 'visual'}">
										<c:forEach items="${dailyList}" var="each" varStatus="loop">
											<c:set var="counselCnt4" value="0"/>
											<c:forEach items="${harmFirstTypeList}" var="each2" varStatus="loop">	
												<c:if test="${each.days eq each2.regDate}">
									...
									<c:if test="${harmFirstType eq 'etc'}">
										<c:forEach items="${dailyList}" var="each" varStatus="loop">
											<c:set var="counselCnt5" value="0"/>
											<c:forEach items="${harmFirstTypeList}" var="each2" varStatus="loop">	
												<c:if test="${each.days eq each2.regDate}">
								...
								<c:forEach items="${harmSecTypeCbx}" var="harmSecType" varStatus="loop">	
								<tr>
									<c:if test="${loop.index eq 0}">
									<th rowspan="${fn:length(harmSecTypeCbx)}">2차피해</th>
									</c:if>
									<th>
									<c:if test="${harmSecType eq 'security'}">비밀누설/소문유포</c:if>
									<c:if test="${harmSecType eq 'seprate'}">분리조치 미흡</c:if>
									<c:if test="${harmSecType eq 'intention'}">의사에 반한 사건처리</c:if>
									<c:if test="${harmSecType eq 'identity'}">신분상 불이익</c:if>
									<c:if test="${harmSecType eq 'etc'}">그외</c:if>
									</th>
									<c:set var="sum1" value="0"/>
									<c:set var="sum2" value="0"/>
									<c:set var="sum3" value="0"/>
									<c:set var="sum4" value="0"/>
									<c:set var="sum5" value="0"/>
									<c:if test="${harmSecType eq 'security'}">
										<c:forEach items="${dailyList}" var="each" varStatus="loop">
											<c:set var="counselCnt1" value="0"/>
											<c:forEach items="${harmSecTypeList}" var="each2" varStatus="loop">	
												<c:if test="${each.days eq each2.regDate}">
												<c:set var="counselCnt1" value="${each2.counselCnt1}"/>
												</c:if>
											</c:forEach>
									...
									<c:if test="${harmSecType eq 'seprate'}">
										<c:forEach items="${dailyList}" var="each" varStatus="loop">
											<c:set var="counselCnt2" value="0"/>
											<c:forEach items="${harmSecTypeList}" var="each2" varStatus="loop">	
												<c:if test="${each.days eq each2.regDate}">
									...
									<c:if test="${harmSecType eq 'intention'}">
										<c:forEach items="${dailyList}" var="each" varStatus="loop">
											<c:set var="counselCnt3" value="0"/>
											<c:forEach items="${harmSecTypeList}" var="each2" varStatus="loop">	
												<c:if test="${each.days eq each2.regDate}">
									...
									<c:if test="${harmSecType eq 'identity'}">
										<c:forEach items="${dailyList}" var="each" varStatus="loop">
											<c:set var="counselCnt4" value="0"/>
											<c:forEach items="${harmSecTypeList}" var="each2" varStatus="loop">	
												<c:if test="${each.days eq each2.regDate}">
								...
								<c:forEach items="${responseTypeIntroOrgCbx}" var="responseTypeIntroOrg" varStatus="loop">	
								<tr>
									<c:if test="${loop.index eq 0}">
									<th rowspan="${fn:length(responseTypeIntroOrgCbx)}">타 신고기관 안내</th>
									</c:if>
									<th>
									<c:if test="${responseTypeIntroOrg eq 'women'}">여성가족부</c:if>
									<c:if test="${responseTypeIntroOrg eq 'labor'}">고용노동부</c:if>
									<c:if test="${responseTypeIntroOrg eq 'police'}">경찰</c:if>
									<c:if test="${responseTypeIntroOrg eq 'education'}">교육부</c:if>
									<c:if test="${responseTypeIntroOrg eq 'human'}">국가인권위원회</c:if>
									<c:if test="${responseTypeIntroOrg eq 'etc'}">기타</c:if>
									</th>
									<c:set var="sum1" value="0"/>
									<c:set var="sum2" value="0"/>
									<c:set var="sum3" value="0"/>
									...
									<c:set var="sum5" value="0"/>
									<c:set var="sum6" value="0"/>
									<c:if test="${responseTypeIntroOrg eq 'women'}">
										<c:forEach items="${dailyList}" var="each" varStatus="loop">
											<c:set var="counselCnt1" value="0"/>
											<c:forEach items="${responseTypeIntroOrgList}" var="each2" varStatus="loop">	
												<c:if test="${each.days eq each2.regDate}">
												<c:set var="counselCnt1" value="${each2.counselCnt1}"/>
												</c:if>
											</c:forEach>
									...
									<c:if test="${responseTypeIntroOrg eq 'labor'}">
										<c:forEach items="${dailyList}" var="each" varStatus="loop">
											<c:set var="counselCnt2" value="0"/>
											<c:forEach items="${responseTypeIntroOrgList}" var="each2" varStatus="loop">	
												<c:if test="${each.days eq each2.regDate}">
									...
									<c:if test="${responseTypeIntroOrg eq 'police'}">
										<c:forEach items="${dailyList}" var="each" varStatus="loop">
											<c:set var="counselCnt3" value="0"/>
											<c:forEach items="${responseTypeIntroOrgList}" var="each2" varStatus="loop">	
												<c:if test="${each.days eq each2.regDate}">
									...
									<c:if test="${responseTypeIntroOrg eq 'education'}">
										<c:forEach items="${dailyList}" var="each" varStatus="loop">
											<c:set var="counselCnt4" value="0"/>
											<c:forEach items="${responseTypeIntroOrgList}" var="each2" varStatus="loop">	
												<c:if test="${each.days eq each2.regDate}">
									...
									<c:if test="${responseTypeIntroOrg eq 'human'}">
										<c:forEach items="${dailyList}" var="each" varStatus="loop">
											<c:set var="counselCnt5" value="0"/>
											<c:forEach items="${responseTypeIntroOrgList}" var="each2" varStatus="loop">	
												<c:if test="${each.days eq each2.regDate}">
									...
									<c:if test="${responseTypeIntroOrg eq 'etc'}">
										<c:forEach items="${dailyList}" var="each" varStatus="loop">
											<c:set var="counselCnt6" value="0"/>
											<c:forEach items="${responseTypeIntroOrgList}" var="each2" varStatus="loop">	
												<c:if test="${each.days eq each2.regDate}">
								...
								<c:forEach items="${responseTypeServiceRelCbx}" var="responseTypeServiceRel" varStatus="loop">	
								<tr>
									<c:if test="${loop.index eq 0}">
									<th rowspan="${fn:length(responseTypeServiceRelCbx)}">서비스연계</th>
									</c:if>
									<th>
									<c:if test="${responseTypeServiceRel eq 'con'}">상담</c:if>
									<c:if test="${responseTypeServiceRel eq 'law'}">법률/노무</c:if>
									<c:if test="${responseTypeServiceRel eq 'medical'}">의료</c:if>
									<c:if test="${responseTypeServiceRel eq 'etc'}">그외</c:if>
									</th>
									<c:set var="sum1" value="0"/>
									<c:set var="sum2" value="0"/>
									<c:set var="sum3" value="0"/>
									<c:set var="sum4" value="0"/>
									<c:if test="${responseTypeServiceRel eq 'con'}">
										<c:forEach items="${dailyList}" var="each" varStatus="loop">
											<c:set var="counselCnt1" value="0"/>
											<c:forEach items="${responseTypeServiceRelList}" var="each2" varStatus="loop">	
												<c:if test="${each.days eq each2.regDate}">
												<c:set var="counselCnt1" value="${each2.counselCnt1}"/>
												</c:if>
											</c:forEach>
									...
									<c:if test="${responseTypeServiceRel eq 'law'}">
										<c:forEach items="${dailyList}" var="each" varStatus="loop">
											<c:set var="counselCnt2" value="0"/>
											<c:forEach items="${responseTypeServiceRelList}" var="each2" varStatus="loop">	
												<c:if test="${each.days eq each2.regDate}">
									...
									<c:if test="${responseTypeServiceRel eq 'medical'}">
										<c:forEach items="${dailyList}" var="each" varStatus="loop">
											<c:set var="counselCnt3" value="0"/>
											<c:forEach items="${responseTypeServiceRelList}" var="each2" varStatus="loop">	
												<c:if test="${each.days eq each2.regDate}">
									...
									<c:if test="${responseTypeServiceRel eq 'etc'}">
										<c:forEach items="${dailyList}" var="each" varStatus="loop">
											<c:set var="counselCnt4" value="0"/>
											<c:forEach items="${responseTypeServiceRelList}" var="each2" varStatus="loop">	
												<c:if test="${each.days eq each2.regDate}">
...
<!-- 						<tfoot> 
	...
	$(function(){
	 ...
	 function inq(){
		...
		$('#ZStatisticsMngVo').attr('action','/admsys/statisticsmng/index.html');
