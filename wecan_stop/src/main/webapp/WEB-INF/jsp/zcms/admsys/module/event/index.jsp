		...
		<div id="r_side">
			...
			<form:form modelAttribute="zEventVo" name="frm" method="post">
				...
				<div class="page_title">
					<h3>
						<img src="/cms/image/tit_event_set.jpg" alt="이벤트관리" />
					</h3>
				</div>
				<div id="content">
					<div class="main_btn">
						<ul>
							<li>
								<a href="javascript:checkAll(true,'eventno');"><img alt="전체선택" src="/cms/image/common_btn_selall.jpg" /></a>
							</li>
							<li>
								<a href="javascript:checkAll(false,'eventno');"><img alt="선택해제" src="/cms/image/common_btn_release.jpg" /></a>
							</li>
							<li>
								<a href="javascript:del('eventno');"><img alt="삭제" src="/cms/image/common_btn_del.jpg" /></a>
							</li>
						</ul>
					...
					<div class="main_table">
						<!---게시판 영역------------------------->
						<table class="main_table1" border="1" cellspacing="1" cellpadding="2" width="100%" summary="이벤트폼리스트">
							<caption>이벤트폼리스트</caption>
							<colgroup>
								<col width="5" />
								<col width="5%" />
								<col width="" />
...
<!-- 								<col width="80" />
 -->								<col width="120" />
							...
							<thead>
								<tr>
									<th>
										<input class="bor_none" id="batch" type="checkbox" onclick="javascript:checkAll('','eventno')" />
									</th>
									<th>번호</th>
									<th>제목</th>
									<th>대상</th>
 ...
 -->									<th>관리</th>
							...
							<tbody>
								<c:forEach items="${list}" var="each" varStatus="loop">
									<tr>
										<td rowspan="2">
											<c:set value="${each.eventno}" var="k" />
											<input class="bor_none" name="eventno" value="${k}" type="checkbox" />
										</td>
										<td rowspan="2">
...
<%-- 										<td>
											<c:url value="/PrvwEtc" var="url">
												...
												<c:param name="no" value="${data.eventno}" />
									...
									<tr>
										<td colspan="9" style="padding:0">
											<table class="replacement_words" cellpadding=0 border=0 cellspacing=0 width=100%>
												<tr>
													<th width=50 style="">
														<a href="javascript:void(0)" onclick="copytoclipboard('&lt;call type=&#34;event&#34; skin=&#34;${each.skin}&#34; no=&#34;${each.eventno}&#34; &#47;&gt;');">
