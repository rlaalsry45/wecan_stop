    ...
    <div id="r_side">
        <div id="contents">
            <div class="contants_top">
                <div class="location">
                    <a href="/admsys/dashboard/index.html">HOME</a> <a href="/admsys/orgculturedigmng/index.html">성희롱방지 조직문화진단관리</a> <a href="index.html">만족도조사 관리</a> <strong>만족도조사 결과</strong>
                </div>
            </div>
            <div id="content">
                        ...
                        <div class="main_table">
                            <table class="main_table1 bgneno" summary="제목, ID, 기관명, 상태, 기간설정, 설명, 응답자수">
                                ...
                                <tr>
                    				...
                    				<td class="Tleft">${result.satisfactionid}</td>
               					</tr>
                				<tr>
