...
<table style="width:100%" class="table-search-condition">
	<tr>
		...
		<td>등록일</td>
		<td>
			시작일:<input type="date" id="registration_date_from" name="registration_date_from" value="${data.registration_date_from}" min="2019-01-01" max="2030-12-31" placeholder="년/월/일"><br>
			종료일:<input type="date" id="registration_date_to" name="registration_date_to" value="${data.registration_date_to}" min="2019-01-01" max="2030-12-31" placeholder="년/월/일">
		</td>
		<td>상담일</td>
		<td>
			시작일:<input type="date" id="consulting_start_date_from" name="consulting_start_date_from" value="${data.consulting_start_date_from}" min="2019-01-01" max="2030-12-31" placeholder="년/월/일"><br>
			종료일:<input type="date" id="consulting_start_date_to" name="consulting_start_date_to" value="${data.consulting_start_date_to}" min="2019-01-01" max="2030-12-31" placeholder="년/월/일">
		</td>
		<td>분류</td>
