...
<jsp:include page="../../lnb.jsp" flush="true" />
            ...
            <div id="contents">
               <div class="contants_top">
                    <div class="location">
                    	<a href="/admsys/dashboard/index.html">HOME</a> <a href="/admsys/consultingmng/allcmsrch.html">상담관리</a> <a href="index.html">만족도조사 관리</a> <strong>만족도조사 등록</strong>
                    </div>
                </div>
                        ...
                        <ul class="homepagebbs">
                            ...
                            <li>
                                <div class="main_table">
                                    <!-- 게시판 영역 -->
                                    <table class="main_table1 bgneno" summary="제목, 기간 설정, 대상 선택, 메인에 보기 표시, 설명, 문항 관리">
                                        ...
                                        <tr>
                                            ...
                                            <td class="Tleft">
                                                시작 :
												<input id="d4311" name="sdate" class="Wdate" type="text" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm',maxDate:'#F{$dp.$D(\'d4312\')}'})" readonly="readonly"/>
												~
												종료 :
												<input id="d4312" name="edate" class="Wdate" type="text" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm',minDate:'#F{$dp.$D(\'d4311\')}'})" readonly="readonly"/>
                                            </td>
                                        </tr>
                                        <tr>
