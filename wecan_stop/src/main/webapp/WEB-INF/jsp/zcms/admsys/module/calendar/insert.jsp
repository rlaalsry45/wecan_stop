    ...
    <div id="r_side">
        <div id="contents">
            <div class="contants_top">
                <div class="location">
                    <a href="/admsys/dashboard/index.html">HOME</a> <a href="/admsys/site/site/index.html">시스템관리</a> <strong>캘린더설정 입력</strong>
                </div>
            </div>

            <!--/cont_top-->
            <form:form id="insert" name="insert" action="/admsys/module/calendar/insert.html" method="post" enctype="multipart/form-data"
                ...
                <div id="content">
                    <ul class="homepagebbs">
                        <li class="bg"><h3 class="sub">캘린더 설정</h3></li>
                        <li>
                                ...
                                <table class="main_table1 bgneno" summary="캘린더 이름, 언어선택, menuno, siteno, 사용여부">
                                    ...
                                    <tr>
                                        ...
                                        <td class="Tbod Tbod Tleft">
                                            <input class="bor1ddd" type="text" name="calendar_name" id="calendar_name" size="100"
                                    ...
                                    <!-- <tr>
                                        ...
                                        <td class="Tleft">
                                            <input class="bor1ddd" type="text" name="menuno" id="menuno" size="10" onkeypress="onlyNumber();">
                                        </td>
                                    </tr> -->
                                    <!-- <tr>
                                        <th class="Tbornone Tleft" scope="row">siteno</th>
                                        <td class="Tleft">
                                            <input class="bor1ddd" type="text" name="siteno" id="siteno" size="10" onkeypress="onlyNumber();">
                                        </td>
                                    </tr> -->
                                    <tr>
                            ...
                            <div class="btn-c-B">
                                <a class="btmore04" href="javascript:void(0)" onclick="checkdata()" class="gray">등록</a>
                                <a class="btmore09" href="javascript:void(0);"
                                   onclick="if(window.confirm('입력한 내용이 삭제되고 리스트화면으로 이동합니다.\r\n그래도 진행 하시겠습니까?')) this.href='/admsys/module/calendar/index.html'">취소</a>
                            </div>
                            <!--
