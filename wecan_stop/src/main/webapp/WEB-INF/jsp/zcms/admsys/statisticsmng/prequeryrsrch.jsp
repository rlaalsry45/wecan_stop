                ...
                <form:form modelAttribute="ZStatisticsMngVo" name="frm" method="post">
                    ...
                    <div id="content">
											...
											<tbody>
												...
												<tr>
													...
													<td>
														...
														<div class="input_box">
															<input type="checkbox" name="prequery1" id="chk_pre1" value="1" <c:if test="${input.prequery1 eq '1'}">checked</c:if>>
															<label for="chk_pre1" class="on">중앙부처/국가기관</label>
														</div>
														<div class="input_box">
															<input type="checkbox" name="prequery1" id="chk_pre2" value="2" <c:if test="${input.prequery1 eq '2'}">checked</c:if>>
															<label for="chk_pre2" class="on">지방자치단체</label>
														</div>
														<div class="input_box">
															<input type="checkbox" name="prequery1" id="chk_pre3" value="3" <c:if test="${input.prequery1 eq '3'}">checked</c:if>>
															<label for="chk_pre3" class="on">공직유관단체</label>
														</div>
														<div class="input_box">
															<input type="checkbox" name="prequery1" id="chk_pre4" value="4" <c:if test="${input.prequery1 eq '4'}">checked</c:if>>
															<label for="chk_pre4" class="on">초·중·고교</label>
														</div>
														<div class="input_box">
															<input type="checkbox" name="prequery1" id="chk_pre5" value="5" <c:if test="${input.prequery1 eq '5'}">checked</c:if>>
															<label for="chk_pre5" class="on">대학교</label>
														</div>
														<div class="input_box">
															<input type="checkbox" name="prequery1" id="chk_pre6" value="6" <c:if test="${input.prequery1 eq '6'}">checked</c:if>>
															<label for="chk_pre6" class="on">민간/기타</label>
														</div>
													</td>
												</tr>
												<tr>
                        ...
                        <script type="text/javascript">
	                        $(document).on('click', "input[name='prequery1']", function(){
	                            if(this.checked) {
	                                const checkboxes = $("input[name='prequery1']");
