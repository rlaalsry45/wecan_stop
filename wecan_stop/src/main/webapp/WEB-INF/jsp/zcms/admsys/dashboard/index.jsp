...
<script type="text/javascript">
	...
	function chkPassDay(){
		...
		var chkPass = Number('${chkPassDay}');
			
		if(90 <= chkPass){
		
			var url="/admsys/user/common/chkpassword.html";
			var option="toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=no,resizable=no,width=1050,height=588,left=500,top=250";
			
			window.open(url,"validationPass",option);
			
			var myForm = document.validationPass;
			myForm.action = url;
			myForm.method = "post";
			myForm.target = "validationPass";
			myForm.submit();  
...
<div class="lnb">
	...
	<form id = "validationPass" name = "validationPass">
		<input type = "hidden" name = "chkPassDay" id = "chkPassDay" value = "${chkPassDay}"/>
	</form>
