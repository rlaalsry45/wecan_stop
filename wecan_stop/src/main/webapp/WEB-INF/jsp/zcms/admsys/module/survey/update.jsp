...
<div id="container">
    ...
    <div id="contents">
        <div class="contants_top">
            <div class="location">
                <a href="/admsys/dashboard/index.html">HOME</a> <a href="/admsys/orgculturedigmng/index.html">성희롱방지 조직문화진단관리</a> <a href="index.html">설문조사 관리</a> <strong>설문조사 수정</strong>
            </div>
        </div>
        <form:form modelAttribute="zSurveyVo" name="frm" method="post" id="survey_form">
        ...
        <div id="content">
            ...
            <table class="main_table1 bgneno" summary="제목, ID, 기관명, 상태, 기간설정, 설명, 응답자수">
                ...
                <tr>
                    ...
                    <td class="Tleft">
                        <input type="text" name="orgid" id="orgid" class="bor1ddd" size="50" value="${detail.orgid}" />
                    </td>
                </tr>
                <tr>
                    <th class="Tbornone Tleft">진단일지</th>
                    <td class="Tleft">
                        <input type="text" name="consultingapplicationno" id="consultingapplicationno" class="bor1ddd" size="50" value="${detail.consultingapplicationno}" />
                    </td>
                </tr>
                <tr>
                    <th class="Tbornone Tleft">유형</th>
                    <td class="Tleft">
                    	<input type="radio" class="radio1" name="surveytype" value="A" <c:if test="${detail.surveytype eq 'A'}">checked="checked"</c:if> />
                        A
                        <input type="radio" class="radio1" name="surveytype" value="B" <c:if test="${detail.surveytype eq 'B'}">checked="checked"</c:if> />
                        B
                    </td>
                </tr>
                <tr>
