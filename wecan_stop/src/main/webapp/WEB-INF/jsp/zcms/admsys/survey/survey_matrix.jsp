...
<jsp:include page="../lnb.jsp" flush="true"/>
        <div id="contents">
            <form:form modelAttribute="sdsSurveyEventVo" name="frm" method="post">
                <input type="hidden" name="event" value="${eventData.event}">
                    ...
                    <ul class="homepagebbs">
                        ...
                        <li>
                            <div class="main_table bold">
                                <table class="main_table1" width="100%" summary="설문제목, 사용년도, 제출기간">
                                    ...
                                    <tr>
                                        ...
                                        <td class="Tleft Tbod">
                                            <input class="bor1ddd w90" id="title" type="text" name="title" value="${eventData.title}">
                                        </td>
                                        <th><label class="on" for="d4311">제출기간</label></th>
                                        <td class="Tleft Tbod">
                                            <input id="d4311" class="Wdate" type="text" style="width:128px;" value="${eventData.alpha}" onfocus="WdatePicker({maxDate:'#F{$dp.$D(\'d4312\')}'})" name="alpha"> ~
                                            <input id="d4312" class="Wdate" type="text" style="width:128px;" value="${eventData.omega}" onfocus="WdatePicker({minDate:'#F{$dp.$D(\'d4311\')}'})" name="omega">
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
                                ...
                                <div id="major">
                                    ...
                                    <h4 class="tmg30">
                                        ...
                                        <input class="bor1ddd w20" id="major-title" type="text" name="major-title" value="${major.title}">
                                    ...
                                    <div id="minor" class="question">
                                        ...
                                        <h5 class="new">
                                            ...
                                            <input class="bor1ddd w20" id="minor-title" type="text" name="minor-title" value="${minor.title}">
                                        ...
                                        <table class="main_table1" width="100%" summary="no, 문항, 문항유형, 관리, 점수">
                                            ...
                                            <tr id="query">
                                                ...
                                                <td class="Tleft">
                                                    <input class="bor1ddd w100" type="text" id="query-query" name="query-query" value="${query.query}">
                                                </td>
                                                <td>
                                                    <select name="query-style">
                                                        <option value="1" <c:if test="${query.style==1}"><c:out value=' selected' /></c:if>>5지선다
                                                        <option value="2" <c:if test="${query.style==2}"><c:out value=' selected' /></c:if>>예/아니오
                                                    </select>
                                                </td>
                                                <td>
                                            ...
                                            <tr id="guide" class="bcolor" <c:if test="${query.guide eq null}"><c:out value=" style=display:none"/></c:if>>
                                                <td>&nbsp;</td>
                                                <td colspan="4" class="Tleft">
                                                    가이드라인 <input class="bor1ddd w80" type="text" name="query-guide" value="${query.guide}">
                                                </td>
                                            </tr>
                                            </c:if>
                                            </c:forEach>
                                            <tr>
                                                ...
                                                <td class="colorB">
                                                    <input class="bor1ddd w40" type="text" id="minor-score" name="minor-score" value="${minor.score}">
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
