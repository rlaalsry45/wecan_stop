...
<body>
	<div id="pop-wrap">
		...
		<%-- <a href="javascript:void(0)" class="move"><img onclick ="goArchv('http://kf.or.kr/?menuno=${archv_menuno}&type=view&archv_no=${archv.archv_no}&path=${archv.path}&tab=2')" src="/usr/image/common/btn/btn_move02.gif" alt="아카이브로 이동" /></a> --%>
