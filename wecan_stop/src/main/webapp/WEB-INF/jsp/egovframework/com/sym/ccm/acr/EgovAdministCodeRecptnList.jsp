...
<table width="700" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="40%"class="title_left">
   ...
   <img src="/com/art/egovframework/com/sym/ccm/acr/icon/tit_icon.gif" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목아이콘이미지">&nbsp;법정동코드수신 목록</td>
  <th>
  </th>
  <td width="10%">
  ...
  <th width="10%">
   <table border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td><img src="/com/art/egovframework/com/sym/ccm/acr/button/bu2_left.gif" alt="조회" width="8" height="20"></td>
      ...
      <td><img src="/com/art/egovframework/com/sym/ccm/acr/button/bu2_right.gif" alt="조회" width="8" height="20"></td>
    </tr>
   </table>
  </th>
 </tr>
