...
<table width="100%" cellpadding="0" class="table-search" border="0" style="margin-left:20px;">
 <tr>
  <td width="100%" class="title_left" style="padding-bottom:15px;">
  <h4 class="stit" style="margin-left:0px;">공통상세코드 상세조회</h4>
  <!--
  <h1 class="title_left">
   <img src="<c:url value='/com/art/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목아이콘이미지">&nbsp;공통상세코드 상세조회</h1>
   -->
   </td>
 </tr>
</table>
<table width="98%" class="input_table etc-board" style="margin-left:20px;" summary="코드ID명, 코드, 코드명, 코드설명, 사용여부가 나타나 있는 공통상세코드 상세조회 테이블이다.">
<CAPTION style="display: none;">공통상세코드 상세조회</CAPTION>
  <tr>
    <th width="20%" height="23" class="required_text" scope="row" nowrap style="text-align:center;">코드ID명<img src="<c:url value='/com/art/egovframework/com/cmm/icon/required.gif' />" alt="필수입력표시"  width="15" height="15"></th>
  ...
  <tr>
    <th width="20%" height="23" class="required_text" scope="row" nowrap style="text-align:center;">코드명<img src="<c:url value='/com/art/egovframework/com/cmm/icon/required.gif' />" alt="필수입력표시"  width="15" height="15"></th>
    <td>${result.codeNm}</td>
  </tr>
  <tr>
...
<tr>
  ...
  <td style="background-image:URL(<c:url value='/com/art/egovframework/com/cmm/btn/bu2_bg.gif'/>);" class="text_left" nowrap><a href="#noscript" onclick="fnList(); return false;">목록</a>
