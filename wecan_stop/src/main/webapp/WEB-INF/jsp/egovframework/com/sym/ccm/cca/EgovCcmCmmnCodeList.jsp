...
<table width="100%" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="" class="title_left" style="padding-bottom:15px;">
   <h4 class="stit" style="margin-left:0px;">공통코드 목록</h4>
   <!--<h1 class="title_left">
   <img src="<c:url value='/com/art/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목아이콘이미지">&nbsp;공통코드 목록</h1>
   -->
   </td>
  <th>
  </th>
  <td width="10%" align="left">
   	<select name="searchCondition" class="select" id="searchCondition" style="height:23px;">
  ...
  <td align="left" width="11%" style="padding-left:3px;">
    <input name="searchKeyword" type="text" size="35" value="${searchVO.searchKeyword}"  maxlength="35" style="border:1px solid #ddd;height:20px;" />
  </td>
...
<!--
      ...
      <td style="background-image:URL(<c:url value='/com/art/egovframework/com/cmm/btn/bu2_bg.gif'/>);" class="text_left" nowrap><a href="#noscript" onclick="fnRegist(); return false;">등록</a></td>
...
<table class="main_table1"width="100%"  summary="분류명, 코드ID, 코드ID명, 사용여부를 가지고있는 공통코드 목록 테이블이다.">
