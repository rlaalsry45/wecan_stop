...
<link href="<c:url value='/com/css/egovframework/com/cmm/com.css' />" rel="stylesheet" type="text/css">
...
<div id="border" style="width:730px">
	<table width="100%" cellpadding="8" class="table-search" border="0"  summary="게시판명, 커뮤니티 동호회 정보  입니다">
	 <tr>
	  <td width="100%"class="title_left">
	  	<h1>
	  		<img src="<c:url value='/com/art/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="제목아이콘이미지">&nbsp;게시판 사용등록
	  	</h1>
	  </td>
	 </tr>
	</table>
	<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register">
	  <tr>
	    ...
	    <img src="<c:url value='/com/art/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시"></th>
	    <td width="70%" nowrap colspan="3">
	      ...
	      &nbsp;<a href="#LINK" onclick="fn_egov_inqire_bbsInf();" style="selector-dummy: expression(this.hideFocus=false);"><img src="<c:url value='/com/art/egovframework/com/cmm/icon/search.gif' />"
	  ...
	  <tr>
	    <th width="30%" height="23" class="required_text" nowrap >
	    	...
	    	<img src="<c:url value='/com/art/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시">
	    </th>
	    <td width="70%" nowrap colspan="3">
	...
	<tr>
	  <!--
      <td><img src="<c:url value='/com/art/egovframework/com/cmm/btn/bu2_left.gif'/>" width="8" height="20" alt="버튼이미지"></td>
      <td background="<c:url value='/com/art/egovframework/com/cmm/btn/bu2_bg.gif'/>" class="text_left" nowrap>
	  ...
	  <td><img src="<c:url value='/com/art/egovframework/com/cmm/btn/bu2_right.gif'/>" width="8" height="20" alt="버튼이미지"></td> -->
