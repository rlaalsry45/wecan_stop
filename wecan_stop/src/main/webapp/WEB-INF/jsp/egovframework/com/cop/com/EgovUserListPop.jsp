...
<c:set var="ImgUrl" value="${pageContext.request.contextPath}/com/art/egovframework/com/cmm/"/>
	...
	<table width="100%" cellpadding="8" class="table-search" border="0">
	 <tr>
	  <td width="40%"class="title_left">
	  	<h1>
	  		<img src="<c:url value='/com/art/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="제목버튼이미지">&nbsp;사용자 목록
	  	</h1>
	  </td>
	  <th >
	  </th>
