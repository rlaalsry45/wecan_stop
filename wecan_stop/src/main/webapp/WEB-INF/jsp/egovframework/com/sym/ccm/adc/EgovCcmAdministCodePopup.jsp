...
<link type="text/css" rel="stylesheet" href="<c:url value='/com/css/egovframework/com/sym/cal/cal.css' />" >
...
-->
<!-- FIREFOX -->
<iframe title="행정코드" name="ifadminist" src="<c:url value='/sym/ccm/adc/EgovCcmAdministCode.do'/>" style="width:600px; height:500px;" frameborder=0></iframe>
