...
<link type="text/css" rel="stylesheet" href="/com/css/egovframework/com/sym/ccm/acr/button.css">
...
<table width="700" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%" class="title_left">
   <img src="/com/art/egovframework/com/sym/ccm/acr/icon/tit_icon.gif" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목아이콘이미지">&nbsp;법정동코드 상세조회</td>
 </tr>
</table>
...
<c:if test="${result.administZoneCode != null}">
  <tr>
    <th width="30%" height="23" class="required_text" nowrap >법정동코드<img src="/com/art/egovframework/com/sym/ccm/acr/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>
    <td><c:out value="${result.administZoneCode}"/></td>
  </tr>
  <tr>
    <th width="30%" height="23" class="required_text" nowrap >행정구역명<img src="/com/art/egovframework/com/sym/ccm/acr/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>
    <td><c:out value="${result.administZoneNm}"/></td>
  </tr>
  <tr>
    <th width="20%" height="23" class="required_text" nowrap >생성일자<img src="/com/art/egovframework/com/sym/ccm/acr/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>
  ...
  <tr>
    <th width="20%" height="23" class="required_text" nowrap >폐지유무<img src="/com/art/egovframework/com/ssi/syi/sim/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>
    <td width="80%" nowrap>
...
<tbody>
<c:forEach items="${administCodeRecptnList}" var="resultInfo" varStatus="loop">
<tr>
	<td class="lt_text3" nowrap><c:out value="${loop.count}"/></td>
    ...
    <td class="lt_text" nowrap>
		<select title="변경구분" name="changeSeCode" class="select" disabled="disabled">
		    ...
		    <c:forEach var="result" items="${changeSeCodeList}" varStatus="loop">
    ...
    <td class="lt_text" nowrap>
		<select title="처리구분" name="processSe" class="select" disabled="disabled">
		    ...
		    <c:forEach var="result" items="${processSeList}" varStatus="loop">
