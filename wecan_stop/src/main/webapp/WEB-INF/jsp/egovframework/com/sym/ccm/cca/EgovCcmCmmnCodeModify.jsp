...
<table width="700" cellpadding="8" class="table-search" border="0">
 <tr>
  ...
  <h4 class="stit">공통코드 수정</h4>
  <!--
  <h1 class="title_left">
   <img src="<c:url value='/com/art/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목아이콘이미지">&nbsp;공통코드 수정</h1>
   -->
   </td>
...
<!-- 등록  폼 영역  -->
<table width="90%" class="input_table etc-board" style="" summary="코드ID명, 코드ID설명, 사용여부를 수정하는 공통코드 수정 테이블이다.">
...
<div class="btn-c05">
	...
	<input type="submit" value="저장" onclick="fn_egov_modify_CmmnCode(document.cmmnCode); return false;" class="gray">
</div>
<!--
