...
<table width="700" cellpadding="8" class="table-search" border="0">
 <tr>
  ...
  <h4 class="stit">공통코드 등록</h4>
  <!--
  <h1 class="title_left">
   <img src="<c:url value='/com/art/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목아이콘이미지">&nbsp;공통코드 등록</h1>
   -->
   </td>
 </tr>
</table>
...
<!-- 등록  폼 영역  -->
<table width="90%" class="input_table etc-board" style="" summary="분류코드, 코드ID, 코드ID명, 코드ID설명, 사용여부를 입력하는 공통코드 등록 테이블이다.">
<CAPTION style="display: none;">공통코드 등록</CAPTION>
  <tr>
    <th width="20%" height="23" class="required_text" scope="row" nowrap style="text-align:center;"><label for="clCode">분류코드</label><img src="<c:url value='/com/art/egovframework/com/cmm/icon/required.gif' />" alt="필수입력표시"  width="15" height="15"></th>
    <td width="80%" nowrap colspan="3">
		<select name="clCode" class="select" id="clCode">
			<c:forEach var="result" items="${cmmnClCode}" varStatus="loop">
  ...
  <tr>
    <th width="20%" height="23" class="required_text" scope="row" nowrap style="text-align:center;"><label for="codeId">코드ID</label><img src="<c:url value='/com/art/egovframework/com/cmm/icon/required.gif' />" alt="필수입력표시"  width="15" height="15"></th>
    <td width="80%" nowrap colspan="3">
  ...
  <tr>
    <th width="20%" height="23" class="required_text" scope="row" nowrap style="text-align:center;"><label for="codeIdNm">코드ID명</label><img src="<c:url value='/com/art/egovframework/com/cmm/icon/required.gif' />" alt="필수입력표시"  width="15" height="15"></th>
    <td width="80%" nowrap>
  ...
  <tr>
    <th height="23" class="required_text" scope="row" style="text-align:center;"><label for="codeIdDc">코드ID설명</label><img src="<c:url value='/com/art/egovframework/com/cmm/icon/required.gif' />" alt="필수입력표시"  width="15" height="15"></th>
    <td>
...
<!-- 목록/저장버튼  -->
<div class="btn-c05">
	<input type="submit" value="목록" onclick="fn_egov_list_CmmnCode(); return false;" class="gray">
	<input type="submit" value="저장" onclick="fn_egov_regist_CmmnCode(document.cmmnCode); return false;" class="gray">
</div>
<!--
...
<tr>
  ...
  <td style="background-image:URL(<c:url value='/com/art/egovframework/com/cmm/btn/bu2_bg.gif'/>);" class="text_left" nowrap><a href="#noscript" onclick="fn_egov_list_CmmnCode(); return false;">목록</a></td>
