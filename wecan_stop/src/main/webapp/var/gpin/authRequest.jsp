...
<%
    ...
    session.setAttribute("gpinAuthRetPage", "/gpin_authResponse.html");
    ...
    if (login != null && login.equals("login")) {
        System.out.println("gpin_login_session in-----------");
        session.setAttribute("login", "login");
    }

    String gpin_to = request.getParameter("_to");
    System.out.println("gpin_to" + gpin_to);
    if (gpin_to != null) {
        System.out.println("gpin_to_session in-----------");
        session.setAttribute("gpin_to", gpin_to);
    }
