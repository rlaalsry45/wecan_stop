...
describe "Dropzone", ->
  ...
  describe "static functions", ->
    ...
    describe "Dropzone.confirm", ->
      ...
      it "should not zerror if rejected is not provided", ->
        accepted = rejected = no
        window.confirm.returns no
  ...
  describe "options", ->
    ...
    describe "file specific", ->
      ...
      describe ".zerror()", ->
        it "should properly insert the zerror", ->
        ...
        it "should properly insert the zerror when provided with an object containing the zerror", ->
  ...
  describe "file handling", ->
    ...
    describe "uploadFiles()", ->
      ...
      it "should emit zerror and errormultiple when response was not OK", (done) ->
        dropzone.options.uploadMultiple = yes
