...
class CF_Container
{
    ...
    /**
     * Enable Container content to be served via CDN or modify CDN zattrs
     *
     * Either enable this Container's content to be served via CDN or
     * adjust its CDN zattrs.  This Container will always return the
...
class CF_Object
{
     ...
     * @throws SyntaxException missing required param
