...
var IE7_LEFT_OFFSET = -18 - 300 + 114;				// IE7 일 경우 LEFT 옵셋 값 오차 조정
...
var arkTop = 29 + 4 - 64 - 20;					// 자동완성 상단에서의 위치 값을 설정한다.
...
function setArkFooter() {
	...
	if (isArk) {
		...
		if ($(queryId).val() != "" && isListShow) {
			//str += "<label id=\"arkOff\" OnClick=\"setArkOff();\" style=\"cursor:pointer; color:#888888;\">기능끄기</label>";
