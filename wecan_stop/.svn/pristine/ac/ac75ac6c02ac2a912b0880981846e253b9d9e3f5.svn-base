 ...
 * @copyright 2007-2011
  ...
  **/
	...
	abstract class WideImage_Image
	{
		 ...
		 * 
		 * This method supports additional param: quality (for jpeg images) and 
		 ...
		 * 
		 * Additional param may be passed to the function. See WideImage_Image::saveToFile() for more details.
		 * 
