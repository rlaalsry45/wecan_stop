	...
	<div class="sch_option">
		<div class="list_sch">
			...
			<select name="key" class="sch_sel02" title="검색하고자 하는 카테고리를 설정할 수 있습니다.">
	            ...
	            <option value='bbstitle' <c:if test="${input.key=='bbstitle'}">selected</c:if>>제공받은 금품</option>
			</select>
...
<table class="list_style_1">
	<caption>게시판 목록이며 등록번호,접수일,제공받은 금품,처리결과,처리일을 제공하고제공받은 금품 링크를 통해 상세페이지로 이동합니다.</caption>
	<colgroup>
		<col width="15%">
		<col width="15%">
		<col width="*">
