...
public class FrontSatisfactionController {
    ...
    @ResponseBody
    public Map<String,Object> cSatisfactionResult(@ModelAttribute("ZSatisfactionResultVo") ZSatisfactionResultVo reqVo, Model model, HttpServletRequest request, HttpSession session) throws Exception {
        ...
        try {
        	...
        	reqVo.setConsulting_application_no(session.getAttribute("consulting_application_no").toString());
        	
        	satisfactionService.cSatisfactionResultWrite(model, reqVo);
    ...
    @RequestMapping(value = "/{satisfactionid}/satisfaction.html")
    public String satisfactionidList(@PathVariable("satisfactionid") String satisfactionid, HttpServletRequest request, Model model) throws Exception {
        ...
        try {
            ...
            model.addAttribute("orgId", satisfactionid);
