...
<table class="view_style_1">
	<caption>" ${view.bbstitle} " 글의 업무, 담당부서, 담당자, 연락처 정보를 제공합니다.</caption>
	<colgroup>
		<col width="13%">
		<col width="*">
		<col width="13%">
	...
	<tbody>
		<tr>
			...
			<td class="td_left">${view.etc7}</td>
			<th scope="row">담당자</th>
			<td class="td_left">${view.etc8}</td>
			<th scope="row">연락처</th>
			<td class="td_left">${view.goal}</td>
		</tr>
...
<c:if test="${sessionScope.frontAuthPassport.role_m ne '0'}">
   <a href="javascript:void(0)" onclick="return submitForm(this,'edit', ${view.bbsno})" class="b_btn_1">수정</a>
</c:if>        
