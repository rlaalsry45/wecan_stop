$(function () {
    ...
    $.fn.submitForm = function (f, a, n) {
        ...
        if (a == "write" || a == "edit" || a == "reply") {
        	frm.setHidden('goal', $(":input[name='goal1']", frm).val()+"-"+$(":input[name='goal2']", frm).val()+"-"+$(":input[name='goal3']", frm).val());
    ...
    $(":input[name^=goal]").inputFilter(function(value){return /^\d*$/.test(value);});    
});
