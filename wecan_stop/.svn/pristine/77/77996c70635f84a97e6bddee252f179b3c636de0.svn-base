...
<table class="write_style_1">
	<caption>" ${detail.bbstitle} " 쓰기 페이지입니다. 등록번호, 사업명, 주요내용, 사업부서, 담당자, 공표형태로 구성된 테이블입니다.</caption>
	<colgroup>
		<col width="12%">
		<col width="auto">
	</colgroup>
	<tbody>
		...
		<tr>
			...
			<td><input type="text" name="etc3" id="etc3" title="등록번호" class="input_1" value='${detail.etc3}'></td>
		</tr>
		<tr>
			<th scope="row"><label for="bbstitle">사업명</label></th>
			<td><input type="text" name="bbstitle" id="bbstitle" title="사업명" class="input_1" value='<c:if test="${act=='reply'}">[RE]</c:if>${detail.bbstitle}'></td>
		</tr>
		<tr>
			<th scope="row"><label for="bbsconts">주요내용</label></th>
			<td><input type="text" name="bbsconts" id="bbsconts" title="주요내용" class="input_1" value='${detail.bbsconts}'></td>
		</tr>
		<tr>
			<th scope="row"><label for="etc7">사업부서</label></th>
			<td><input type="text" name="etc7" id="etc7" title="사업부서" class="input_1" value='${detail.etc7}'></td>
		</tr>
		<tr>
			<th scope="row"><label for="etc8">담당자</label></th>
			<td><input type="text" name="etc8" id="etc8" title="담당자" class="input_1" value='${detail.etc8}'></td>
		</tr>
		<tr class="ng-scope">
			<th>첨부파일</th>
			<td>
