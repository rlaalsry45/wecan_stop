...
public class CmmUseDAO extends EgovComAbstractDAO {
    ...
    @SuppressWarnings("unchecked")
    public List<CmmnDetailCode> selectCmmSubCodeDetail(ComDefaultCodeVO vo) throws Exception {
	return (List<CmmnDetailCode>) list("CmmUseDAO.selectCmmSubCodeDetail", vo);
    }
}
