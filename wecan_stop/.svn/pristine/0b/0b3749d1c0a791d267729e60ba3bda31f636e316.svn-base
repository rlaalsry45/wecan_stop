...
<table class="view_style_1">
	<caption>" ${view.bbstitle} " 글의 등록번호, 사업명, 주요내용, 사업부서, 담당자, 공표형태 정보를 제공합니다.</caption>
	<colgroup>
		<col width="13%">
		<col width="*">
		<col width="13%">
	...
	<thead>
		<tr>
			...
			<td class="td_left">${view.etc3}</td>
		</tr>
		<tr>
			<th scope="row">사업명</th>
			<td class="td_left"><c:if test="${view.bbsnotice=='1'}"><font style="color:red;font-weight:bold;">공지</font>&nbsp;</c:if>${view.bbstitle}</td>
		</tr>
		<tr>
			<th scope="row">사업부서</th>
			<td class="td_left"><c:out value="${view.etc7}" escapeXml="false"/></td>
		</tr>
		<tr>
			<th scope="row">담당자</th>
			<td class="td_left"><c:out value="${view.etc8}" escapeXml="false"/></td>
		</tr>
