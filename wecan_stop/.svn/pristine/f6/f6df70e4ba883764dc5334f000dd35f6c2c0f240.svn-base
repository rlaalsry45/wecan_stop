	...
	<c:otherwise><input readonly type="hidden" class="text" name="bbsusername" value="<c:out value='${uservo.username}' />"/></c:otherwise>
		...
		<div class="table_type01">
			...
			<tbody>
				...
				<tr>
					<th scope="row"><label for="lab_wrap04" class="td_wrap">영상원고</label></th>
					<td>
						<div class="td_form">
							<textarea name="etc1" id="etc1" class="bor2ddd" style="height: 170px">${detail.etc1 }</textarea>
						</div>
					</td>
				</tr>
				<tr>
					<th scope="row"><label for="lab_wrap05" class="td_wrap">영상설명</label></th>
					<td>
						<div class="td_form">
