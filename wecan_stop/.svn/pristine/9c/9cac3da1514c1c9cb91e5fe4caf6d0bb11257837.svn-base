...
<ul class="member-kind en">
	...
	<li class="email on"><span>E-mail<br />Verification</span></li>
	<li class="finish"><span>Registration<br />Complete</span></li>
</ul>
<h4 class="sctit">E-mail Verification</h4>
<p class="text">E-mail verification is required for the protection of your personal information.</p>
<div class="email">
	A verification e-mail will be sent to the registered e-mail address.<br />Your registration will be complete when you finish the verification process.<br />Please check your e-mail address.
</div>
<div class="btn-c">
	<a href="/"><img src="/usr/image/common/btn/btn_main.gif" alt="To the Main Page" /></a>
</div>
<!--/여기까지 사용하세요-->