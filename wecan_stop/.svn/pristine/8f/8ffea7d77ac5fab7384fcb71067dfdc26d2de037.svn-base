...
<div class="contents">
	...
	<h3 class="ctit">아카이브</h3>
		...
		<div class="board-view">
			<div class="vod">
				<iframe  title="${archv.title}" width="640" height="480" src="http://www.youtube.com/embed/${archv.vdo_url}?rel=0&autoplay=1" frameborder="0" allowfullscreen></iframe>
			...
			<table class="board-view" summary="게시일, 작성자, 문서">
