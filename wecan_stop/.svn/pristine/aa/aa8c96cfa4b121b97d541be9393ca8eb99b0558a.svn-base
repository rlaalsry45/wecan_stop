...
<body onload="_no_Back();" onpageshow="if(event.persisted)_no_Back();">
				...
				<div class="cont-right">
					...
					<form name="frm" id="frm" method="post"  enctype="multipart/form-data">
						...
						<table class="board-write" summary="아이디, 비밀번호, 비밀번호 확인, 성명(한글), 성명(한자), 성명(영문), 생년월일, E-mail, 우편물 수령">
							...
							<tbody>
								...
								<tr>
									...
									<td><input type="text" class="text" id="username" name="username" title="한글이름 입력" style="width:226px;height:17px;" value=<%=(String)session.getAttribute("niceName")%> readonly/> (예: 홍길동)</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><input type="text" class="text" id="userename" name="Username2" title="영문이름 입력" style="width:226px;height:17px;" /> (예: Hong,Kil-Dong)</td>
								</tr>
								<tr>
									<th scope="row"><label for="years">생년월일</label></th>
									<td class="select">
										<input type="text" class="text" id="years" title="생년월일" style="width:144px;height:17px;" value=<%=(String)session.getAttribute("sBirthDate")%> readonly/>
										<input type="radio" readonly <c:if test="${sessionScope.sGender eq '1'}">checked</c:if><c:if test="${sessionScope.sGender eq '0'||sessionScope.sGender eq null}"> disabled</c:if> class="radio" id="guy" name="usersex" value="1" />
										<label for="guy">남</label>
										<input type="radio" readonly <c:if test="${sessionScope.sGender eq '0'}">checked</c:if><c:if test="${sessionScope.sGender eq '1'||sessionScope.sGender eq null}"> disabled</c:if>  class="radio" id="girl" name="usersex" value="0" />
								...
								<tr>
									...
									<td>
										동의함<input type="radio" value="1" checked class="text" id="newsletter1" name="newsletter1" title="이메일 수신" style="border:0px;" />
										동의안함<input type="radio" value="0" class="text" id="newsletter1" name="newsletter1" title="이메일 수신" style="border:0px;" />
									</td>
								</tr>
							</tbody>
						</table>
						<table class="board-write mgtype20" summary="프로필 사진, 회원종류, 지회선택, 자택, 직장/대학원, 추천인, 추천서">
							...
							<tbody>
								...
								<tr id="semimemberdocutr" style="display:none;">
									<th scope="row"><label for="category">재학증명서 첨부</label></th>
									<td>
										<input type="file" name="semimemberdocu" id="semimemberdocu" onchange="return check_ext(this);" />
										※ jpg,bmp,png,gif 파일만 가능합니다.
									</td>
								</tr>
								<tr>
									<th scope="row">지회선택</th>
									<td>
								...
								<tr>
									...
									<td>
										<input type="text" class="text" id="useraddrno1" name="useraddrno1" title="우편번호 입력" maxlength="10" style="width:104px;height:17px;" readonly/>
										<!-- -
										...
										<ul class="type02">
											...
											<li>
												...
												<input type="text" class="text"name="usertelco" title="국가코드" style="width:72px;height:17px;" maxlength="4" />(국가코드, 국내는 생략가능)<br>
								...
								<tr>
									...
									<td>
										<input type="text" class="text" id="cuseraddrno1" name="cuseraddrno1" title="우편번호 입력" maxlength="10" style="width:104px;height:17px;" readonly/>
										<!-- -
										...
										<ul class="type02">
											<li>
												...
												<input type="text" class="text" id="usercompanyname" name="usercompanyname" title="직장명 입력" style="width:260px;height:17px;" />
											</li>
											<li>
												<label for="department">부 서</label>
												<input type="text" class="text" id="dept_full_nm" name="dept_full_nm" title="부서명 입력" style="width:260px;height:17px;" />
											</li>
											<li>
												<label for="title">직 책</label>
												<input type="text" class="text" id="usercompanystatus" name="usercompanystatus" title="직책 입력" style="width:260px;height:17px;" />
											</li>
											<li>
												<label for="phone02">전 화</label>
												<input type="text" class="text"name="tel_offcco" title="국가코드" style="width:72px;height:17px;" maxlength="4" />(국가코드, 국내는 생략가능)<br>
											...
											<li>
												...
												<input type="text" class="text"name="userfaxco" title="국가코드" style="width:72px;height:17px;" maxlength="4" />(국가코드, 국내는 생략가능)<br>
							...
							<tbody class="type02">
								<tr>
									<td class="first" name="career" >
										...
										<input type="checkbox" id="nowcheck1" value="Y" style="vertical-align: middle;">현재
									...
									<td>
										<input type="text" class="text" id="ctext1" name="careerdata" title="경력사항 입력" style="width:350px;height:17px;" onkeydown="if(event.keyCode == 188) event.returnValue = false;" />
									</td>
								</tr>
								<tr>
									<td class="first" name="career" >
										...
										<input type="checkbox" id="nowcheck2" value="Y" style="vertical-align: middle;">현재
								...
								<tr>
									<td class="first" name="career" >
										...
										<input type="checkbox" id="nowcheck3" value="Y" style="vertical-align: middle;">현재
								...
								<tr>
									<td class="first" name="career" >
										...
										<input type="checkbox" id="nowcheck4" value="Y" style="vertical-align: middle;">현재
								...
								<tr>
									<td class="first" name="career" >
										...
										<input type="checkbox" id="nowcheck5" value="Y" style="vertical-align: middle;">현재
								...
								<tr>
									<td class="first" name="career" >
										...
										<input type="checkbox" id="nowcheck6" value="Y" style="vertical-align: middle;">현재
						...
						<div class="btn-c">
							<a id="submit_btn" href="#none"><img src="/usr/image/common/btn/btn_join.gif" alt="가입하기" /></a>
							<a href="/"><img src="/usr/image/common/btn/btn_cencle.gif" alt="취 소" /></a>
						</div>
					</form>
				</div>
			</div>
