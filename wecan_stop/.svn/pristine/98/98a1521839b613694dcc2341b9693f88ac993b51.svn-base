...
public class PagingTag3 extends TagSupport {
    ...
    public int doStartTag() throws JspException {
        ...
        if (pageMax > 0) {
            ...
            if (pageIndex == 1) {
            	...
            	pt.append("    <a href='javascript:goPaging(1);'>"
                				+ "<img src='/cms/image/sub/btn-next-more_2.png'></a>\n");
                pt.append("    <a class='btnP02' href='javascript:goPaging(" + (pageIndex - 1) +");'><img src='/cms/image/sub/btn-next.png'></a>\n");
            }
            ...
            if (index < 1.0 || pageMax < 10) {
                for (int i = 1; i <= 9; i++) {
                    if (i <= pageMax) {
                        if (pageIndex != i) {
                            pt.append("<span>   <a href='javascript:goPaging(" + i +");'>" + i + "</a></span>\n");
                        } else {
            ...
            if (pageIndex == pageMax || pageMax < 2) {
                ...
                String next = "javascript:goPaging(" + (pageIndex + 1) +");";
                String last = "javascript:goPaging(" + pageMax +");";

                pt.append("<a href='" + next + "'><img src='/cms/image/sub/btn-next-more.png'></a>\n");
                pt.append("<a href='" + last + "'><img src='/cms/image/sub/btn-next_2.png'></a>\n");
            }
            pt.append("</div>\n<!--/paging-->\n");
        }
        try {
