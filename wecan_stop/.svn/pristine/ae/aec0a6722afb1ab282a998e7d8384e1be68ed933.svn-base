	...
	<div class="join">
		<ul>
			<li class="general">
				...
				<a href="javascript:void(0)" onclick="submit_a();"><img src="/usr/image/common/btn/btn_join.gif" alt="Register" /></a>
			</li>
			<li class="junior">
				<strong>Junior Member</strong>
				<p>Koreans under age 14</p>
				<a href="javascript:void(0)" onclick="submit_b();"><img src="/usr/image/common/btn/btn_join.gif" alt="Register" /></a>
			</li>
			<li class="alien">
				<strong>Foreigners</strong>
				<p>Foreigners residing in Korea and abroad</p>
				<a href="javascript:void(0)" onclick="submit_c();"><img src="/usr/image/common/btn/btn_join.gif" alt="Register" /></a>
			</li>
		</ul>
	</div>
</form>
