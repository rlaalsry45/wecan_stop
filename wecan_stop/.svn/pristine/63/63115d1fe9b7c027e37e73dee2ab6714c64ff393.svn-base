...
public class AuthAdminDAOImpl extends EgovComAbstractDAO implements AuthAdminDAO {
	...
	@Override
	public Auth selectZauthAdminUrlByNo(int no) {
		return (Auth)select(sqlMapNs+"selectZauthAdminUrlByNo", no);
	}

	@Override
	public void deleteZauthAdminUrlByUrlNoGrouNo(Auth vo) {
		delete(sqlMapNs+"deleteZauthAdminUrlByUrlNoGrouNo", vo);
