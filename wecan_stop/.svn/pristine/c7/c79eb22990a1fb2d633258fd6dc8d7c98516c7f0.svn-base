 ...
 */
	...
	*/
	 ...
	 function setOpenerValue(newaddr){
		 var result = newaddr.split(","); 
		 window.opener.document.getElementById("useraddr${addrposition}").value = result[0]+" "+result[1];
		 window.opener.document.getElementById("useraddrno${addrposition}").value = result[2];
		 window.opener.document.getElementById("useraddr${addrposition}").focus();
	 ...
	 function selectSearch(mode) {
		 if (mode == 'road'){
				document.location.href = "/skin/newpost/road1.html?addrposition=${addrposition}";
			}else if(mode =='jibun'){
				document.location.href = "/skin/newpost/jibun1.html?addrposition=${addrposition}";
			}else if(mode=='sangho'){
				document.location.href = "/skin/newpost/sangho1.html?addrposition=${addrposition}";
			}		
	}
