...
<div id="container">
	...
	<div id="r_side">
		...
		<!--/cont_top-->
		<form:form id="insert" name="insert" action="/admsys/evnt/insertg.html"  method="post" enctype="multipart/form-data" onSubmit="return insert_submit(this);">
			...
			<div class="main_table">
				...
				<table class="input_table" border="1" cellspacing="0" cellpadding="2" width="100%" summary="아카이브 자료명, 본문 자료 경로, 게시일, 행사행사기간, 작성자">
					...
					<tr>
						...
						<td>
							<input type="text" name="opt_cd_nm" id="opt_cd_nm" size="150">
						</td>
					</tr>
				</table>
