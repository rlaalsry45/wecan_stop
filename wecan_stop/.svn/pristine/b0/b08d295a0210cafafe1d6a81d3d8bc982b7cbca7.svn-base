...
<script type="text/javascript">
	function deleteConsulting() {
		if(window.opener) {
			...
			if(confirm("'${consulting_history_no}'를 삭제 하시겠습니까?")){
				window.opener.deleteConsulting(del_reason);
				self.close();
			}
		}
	}
...
<div id="content">
	<ul class="homepagebbs">
		...
		<li>
			...
			<div class="btn-c">
		        <a class="btmore04" href="javascript:deleteConsulting();">확인</a>
