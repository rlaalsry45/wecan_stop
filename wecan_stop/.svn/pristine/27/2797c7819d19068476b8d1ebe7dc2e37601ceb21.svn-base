...
<body onload="_no_Back();" onpageshow="if(event.persisted)_no_Back();">
				...
				<div class="cont-right">
					...
					<!-- <h4 class="stit">Foreigner Info</h4>
					...
					<form name="frm" id="frm" method="post"  enctype="multipart/form-data">
						...
						<table class="board-write" summary="아이디, 비밀번호, 비밀번호 확인, 성명(한글), 성명(한자), 성명(영문), 생년월일, E-mail, 우편물 수령">
							...
							<tbody>
								...
								<tr>
									...
									<td><input type="text" class="text" id="username" name="username" title="한글이름 입력" style="width:226px;height:17px;" value="${userdata.username}" readonly /> ex: James, Johns)</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><input type="text" class="text" id="userename" name="Username2" title="영문이름 입력" style="width:226px;height:17px;" value="${userdata.username2}" /></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td>
										Agree<input type="radio" value="1" <c:if test="${userdata.newsletter1 eq '1'}">checked</c:if> class="text" id="newsletter1" name="newsletter1" title="이메일 수신" style="border:0px;" />
										Not agree<input type="radio" value="0" <c:if test="${userdata.newsletter1 ne '1'}">checked</c:if> class="text" id="newsletter1" name="newsletter1" title="이메일 수신" style="border:0px;" />
						...
						<table class="board-write mgtype20" summary="프로필 사진, 회원종류, 지회선택, 자택, 직장/대학원, 추천인, 추천서">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<select id="category" name="work_grade">
											...
											<option value="1" <c:if test="${userdata.work_grade eq '1'}">selected</c:if> >Regular Member</option>
											<option value="2" <c:if test="${userdata.work_grade eq '2'}">selected</c:if> >Life-Member</option>
											<option value="3" <c:if test="${userdata.work_grade eq '3'}">selected</c:if> >Associate Member(undergraduate)</option>
										</select>
								...
								<tr>
									...
									<td>
										<input type="text" class="text" id="useraddrno1" name="useraddrno1" title="우편번호 입력" style="width:104px;height:17px;" value="${userdata.useraddrno}" readonly />
										<%-- -
										...
										<input type="text" class="text block" id="useraddr" name="useraddr" title="주소 입력" style="width:315px;height:17px;" value="${userdata.useraddr}" readonly />
										<input type="text" class="text block" id="useraddr2" name="useraddr2" title="상세주소 입력" style="width:315px;height:17px;" value="${userdata.useraddr2}" />
										<ul class="type02">
											<li>
											...
											<li>
												...
												<input type="text" class="text"name="usertelco" title="국가코드" style="width:72px;height:17px;" maxlength="4" value="${userdata.usertelco }"/>Tel<br>
								...
								<tr>
									...
									<td>
										<input type="text" class="text" id="cuseraddrno1" name="cuseraddrno1" title="우편번호 입력" style="width:104px;height:17px;" value="${userdata2.usercaddrno}" readonly/>
										<%-- -
										...
										<input type="text" class="text block" id="cuseraddr" name="usercaddr" title="주소 입력" style="width:315px;height:17px;" value="${userdata2.usercaddr}" readonly/>
										<input type="text" class="text block" id="cuseraddr2" name="usercaddr2" title="상세주소 입력" style="width:315px;height:17px;" value="${userdata2.usercaddr2}" />
										<ul class="type02">
											<li>
											...
											<li>
												...
												<input type="text" class="text"name="tel_offcco" title="국가코드" style="width:72px;height:17px;" maxlength="4" value="${userdata2.tel_offcco }"/>(Country Code)<br>
						...
						<div class="btn-c">
							<a id="submit_btn" href="#none" class="btn_blue">Modify</a>
							<a href="/eng/?menuno=2617&act=usermodify_foreigner_chk" class="btn_gray">Cancel</a>
						</div>
						<!-- <div class="btn-c">
							<a id="submit_btn" href="#none"><img src="/usr/image/common/btn/btn_modify02.gif" alt="가입하기" /></a>
							<a href="/eng/?menuno=2617&act=usermodify_foreigner_chk"><img src="/usr/image/common/btn/btn_cencle.gif" alt="취 소" /></a>
						</div> -->
					</form>
				</div>
			</div>
