...
//                          + "</html>");
    ...
    public Map<String, Object> sendEmail(Model model, HttpServletRequest req, HttpSession session) throws Exception{
		...
		subject = "한국여성인권진흥원 조직문화진단 2차로그인 본인인증 요청"; 
    ...
    @RequestMapping(value = "sendEmail2.html", method = RequestMethod.POST)
    @ResponseBody
    public Map<String, Object> sendEmail2(Model model, HttpServletRequest req, HttpSession session) throws Exception{
