...
<table width="100%" cellpadding="0" class="table-search" border="0" style="margin-left:20px;">
 <tr>
  ...
  <!--
  <h1 class="title_left">
   <img src="<c:url value='/com/art/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목아이콘이미지">&nbsp;공통코드 상세조회</h1>
   -->
   </td>
 </tr>
</table>
<table width="90%" class="input_table etc-board" style="margin-left:20px;" summary="분류코드명, 코드ID, 코드ID명, 코드ID설명, 사용여부를 보여주는 공통코드 상세조회 페이지이다.">
