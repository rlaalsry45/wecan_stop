...
<table width="700" cellpadding="8" class="table-search" border="0">
 <tr>
  ...
  <h4 class="stit">공통상세코드 등록</h4>
  <!--
  <h1 class="title_left">
   <img src="<c:url value='/com/art/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목아이콘이미지">&nbsp;공통상세코드 등록</h1>
   -->
   </td>
 </tr>
</table>
...
<!-- 등록  폼 영역  -->
<table width="90%" class="input_table etc-board" style="" summary="코드ID, 코드, 코드명, 코드설명, 사용여부를 입력하는 공통상세코드 등록 테이블이다.">
<CAPTION style="display: none;">공통상세코드 등록</CAPTION>
  <tr>
    ...
    <td width="80%" nowrap colspan="3">
		<select name="clCode" class="select" onChange="javascript:fn_egov_get_CodeId(document.cmmnDetailCode);" title="clCode">
			<c:forEach var="result" items="${cmmnClCodeList}" varStatus="loop">
		...
		<select name="codeId" class="select" id="codeId">
			<c:forEach var="result" items="${cmmnCodeList}" varStatus="loop">
  ...
  <tr>
    <th width="20%" height="23" class="required_text" scope="row" nowrap style="text-align:center;"><label for="code">코드</label><img src="<c:url value='/com/art/egovframework/com/cmm/icon/required.gif' />" alt="필수입력표시"  width="15" height="15"></th>
    <td width="80%" nowrap>
  ...
  <tr>
    <th width="20%" height="23" class="required_ text" scope="row" nowrap style="text-align:center;"><label for="codeNm">코드명</label><img src="<c:url value='/com/art/egovframework/com/cmm/icon/required.gif' />" alt="필수입력표시"  width="15" height="15"></th>
    <td width="80%" nowrap>
...
<div class="btn-c05">
	...
	<input type="submit" value="저장" onclick="fn_egov_regist_CmmnDetailCode(document.cmmnDetailCode); return false;" class="gray">
</div>
<!--
